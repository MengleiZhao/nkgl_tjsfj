...
let dsSelect_models={
    ...
    "baseModel":function(){
        let str = '<div class="left">' +
            ...
            '</div>' +
            '<div class="center">' +
            /*'<div class="dsButton selectRight"> 选择 </div>' +
            '<div class="dsButton selectLeft"> 删除 </div>' +*/
           /* '<div class="dsButton allRight"> >>> </div>' +
            '<div class="dsButton allLeft"> <<< </div>' +*/
            '<div class="dsButton selectRight"><img src="'+base+'/resource-modality/img/index/kjcdtj.png"></div>' +
            '<div class="dsButton selectLeft"><img src="'+base+'/resource-modality/img/index/kjcdsc.png"></div>' +
            '</div>' +
            '<div class="right">'+
            '<ul class="dsList">' +
            '</ul>' +
