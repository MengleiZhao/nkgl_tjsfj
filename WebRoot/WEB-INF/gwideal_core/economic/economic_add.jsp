...
<form id="economicAddEditForm" action="${base}/economic/save" method="post" data-options="novalidate:true" class="easyui-form" enctype="multipart/form-data">
	<div class="easyui-layout" style="height: 309px;">
		<div class="win-left-div" data-options="region:'west',split:true">
			<div class="win-left-top-div" style="height: 250px">
				<div class="easyui-accordion" style="width:662px;margin-left: 20px;">
					<div title="经济科目" id="djdxqDiv" data-options="iconCls:'icon-xxlb',collapsed:false,collapsible:false" style="overflow:auto;margin-top:10px;">
						<table class="ourtable">
							...
							<tr class="trbody">
								<td class="td1"><span class="style1">*</span>政府科目编号</td>
								<td class="td2">
									<input class="easyui-textbox" style="width: 200px" type="text" name="govementCode" data-options="validType:'length[1,50]'"value="${bean.govementCode}"/>
								</td>
								<td class="td4">&nbsp;</td>
								<td class="td1"></td>
								<td class="td2">
