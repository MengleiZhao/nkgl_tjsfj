						...
						<div title="国外交通补助" data-options="iconCls:'icon-xxlb',collapsed:true,collapsible:true" style="overflow:auto;margin-top:10px;">
							<table class="ourtable" cellpadding="0" cellspacing="0">
								<tr class="trbody">
									...
									<td colspan="3">
										<input id="hotelstd_add_costTraffic" name="costTraffic" value="${bean.costTraffic }"
						...
						<div title="零用费" data-options="iconCls:'icon-xxlb',collapsed:true,collapsible:true" style="overflow:auto;margin-top:10px;">
							<table class="ourtable" cellpadding="0" cellspacing="0">
								<tr class="trbody">
									...
									<td colspan="3">
										<input id="hotelstd_add_costPocket1" name="costPocket1" value="${bean.costPocket1 }"
											class="easyui-numberbox" data-options=""/>
									</td>
								</tr>
								<tr class="trbody">
									...
									<td colspan="3">
										<input id="hotelstd_add_costPocket2" name="costPocket2" value="${bean.costPocket2 }"
											class="easyui-numberbox" data-options=""/>
									</td>
								</tr>
							</table>
