						...
						<div title="资料、交通费" data-options="iconCls:'icon-xxlb',collapsed:true,collapsible:true" style="overflow:auto;margin-top:10px;">
							<table class="ourtable" cellpadding="0" cellspacing="0">
								<tr class="trbody">
									<td class="td1">费用标准</td>
									<td colspan="3">
										<input id="hotelstd_add_costBook" readonly="readonly" name="costBook" value="${bean.costBook }"
											class="easyui-numberbox" data-options=""/>
									</td>
								</tr>
							</table>
						...
						<div title="师资费" data-options="iconCls:'icon-xxlb',collapsed:true,collapsible:true" style="overflow:auto;margin-top:10px;">
							<table class="ourtable" cellpadding="0" cellspacing="0">
								<tr class="trbody">
									...
									<td colspan="3">
										<input id="hotelstd_add_costTeach3" readonly="readonly" name="costTeach3" value="${bean.costTeach3 }"
											class="easyui-numberbox" data-options=""/>
									</td>
								</tr>
								<tr class="trbody">
									...
									<td colspan="3">
										<input id="hotelstd_add_costTeach2" readonly="readonly" name="costTeach2" value="${bean.costTeach2 }"
											class="easyui-numberbox" data-options=""/>
									</td>
								</tr>
								<tr class="trbody">
									...
									<td colspan="3">
										<input id="hotelstd_add_costTeach1" readonly="readonly" name="costTeach1" value="${bean.costTeach1 }"
											class="easyui-numberbox" data-options=""/>
									</td>
								</tr>
							</table>
