			...
			selectOnCheck: true,checkOnSelect:true,remoteSort:true,nowrap:false,striped: true,fitColumns: true" >
				<thead>
					<tr>
						...
						<th data-options="field:'costLevel',align:'right',formatter:meetlevel"  width="20%">会议类型</th>
						...
						<th data-options="field:'costOther',align:'right',resizable:false,sortable:true" width="20%">其他费用[元]</th>
