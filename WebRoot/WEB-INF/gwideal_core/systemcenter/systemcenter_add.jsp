		...
		<div data-options="region:'center',split:true ">
					...
					<table  class="ourtable" cellpadding="0" cellspacing="0" style="width: 580px;margin-top:10px; padding-left:15px; ">
						<tr class="trbody" style="height: 46px;">
							...
							<td colspan="4">
								<input class="easyui-textbox" id="cheter_add_fileName" name="fileName" value="${bean.fileName }"  style="width:453px;height:30px;" data-options="validType:'length[1,24]',required:true" />
							</td>
						</tr>
