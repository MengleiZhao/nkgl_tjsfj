...
.trbody{height: 30px;}
		...
		function copyForm(){
			...
			$('#YBAddEditForm').form('submit', {
				onSubmit: function(){ 
   				...
   				url:base+'/YearsBsaic/copyYears/'+yearId, 
   				success:function(data){
   					if(flag){
   						$.messager.progress('close');
   					}
    ...
    <div class="easyui-layout" fit="true" style="color: #333333">
   		<div data-options="region:'west',split:true"style="width:600px;border-color: dce5e9" id="westDiv">
	    	<form id="YBAddEditForm" action="${base}/YearsBsaic/save" method="post" data-options="novalidate:true" class="easyui-form" enctype="multipart/form-data">
