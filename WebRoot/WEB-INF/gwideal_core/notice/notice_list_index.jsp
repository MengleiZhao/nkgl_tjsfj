...
<div class="list-div">
	<div style="height: 10px;background-color:#f0f5f7 "></div>
		<div class="list-top">
			...
			<div class="list-table" style="height: 510px">
				<table id="noticeTab" class="easyui-datagrid"
				data-options="collapsible:true,url:'${base}/notice/noticePage?order=0',
				method:'post',fit:true,toolbar:'#noticeHelpTab',singleSelect: true,pagination:true,
				selectOnCheck: true,remoteSort:true,nowrap:false,pageSize:10">
					<thead>
						<tr>
							<th data-options="field:'noticeId',hidden:true"></th>
							<th data-options="field:'num',align:'center',resizable:false,sortable:true" style="width: 15%">序号</th>
							<th data-options="field:'noticeTitle',align:'left',resizable:false,sortable:true,formatter:format_reviewNotice" style="width: 25%">公告标题</th>
