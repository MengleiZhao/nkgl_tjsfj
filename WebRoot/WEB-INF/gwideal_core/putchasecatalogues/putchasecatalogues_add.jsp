	...
	<div style="width:660px;border-color: #dce5e9;margin-left: 20px">
		<table cellpadding="0" cellspacing="0" class="ourtable" border="0">
			...
			<tr>
				...
				<td class="td2">
					<select class="easyui-combobox" id="F_flevel" name="flevel" required="required" style="width: 200px;" data-options="editable:false,panelHeight:'auto'">
						<option value="1" <c:if test="${nextLevel=='1'}">selected="selected"</c:if>>一级科目</option>
						<option value="2" <c:if test="${nextLevel=='2'}">selected="selected"</c:if>>二级科目</option>
						<option value="3" <c:if test="${nextLevel=='3'}">selected="selected"</c:if>>三级科目</option>
					</select>
				</td>
				<td style="width: 0px"></td>
				<td class="td1"><span class="style1">*</span>上级目录编码</td>
				<td class="td2">
					<input class="easyui-textbox" type="text" id="F_fpPurCode"  name="fpPurCode"  readonly="readonly" required="required" data-options="validType:'length[1,20]'" style="width: 200px" value="${upCode}"/>
				</td>
			</tr>
			<tr>
