				...
				<tr>
					<td >
						<div class="easyui-accordion" style="width:555px;margin-left: 20px;">
							<div title="二级分类详情" data-options="iconCls:'icon-xxlb',collapsed:false,collapsible:false" style="overflow:auto;margin-top:10px;">
								<table class="ourtable" cellpadding="0" cellspacing="0">
									<tr class="trbody">
									 ...
									 <tr class="trbody">
										...
										<td class="td2">
											<input id="PM_fProType" name="fProType"  value="${bean.fProType }" data-options="url:'${base}/ProMgrLevel/lookupsJson?parentCode=PRO-CLASS&selected=${bean.fProType }',method:'POST',valueField:'code',textField:'text',editable:false,validType:'selectValid'" class="easyui-combobox" style="width: 150;height:25px" />
										</td>
									</tr> 
									<%-- <tr class="trbody">
