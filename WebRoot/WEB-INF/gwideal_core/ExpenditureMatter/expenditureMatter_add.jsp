	...
	<div class="easyui-layout" style="height: 509px;">
		<div class="win-left-div" data-options="region:'west',split:true">
					...
					<div class="easyui-accordion" style="width:662px;margin-left: 20px;">
							<div title="支出事项详情" data-options="iconCls:'icon-xxlb',collapsed:false,collapsible:false" style="overflow:auto;margin-top:10px;">
								<table class="ourtable" cellpadding="0" cellspacing="0">
									...
									<tr class="trbody">
										...
										<td class="td2">
											<input class="easyui-combobox" id="exp_add_type1" name="feType" editable="false"
												style="width: 200px"  value="${bean.feType}" data-options="valueField: 'feType',textField: 'value',
												data: [{feType: '1',value: '通用事项'},{feType: '6',value: '公车运维'}]" 
											/>
											
											
											<!-- ,{feType: '2',value: '会议'},{feType: '3',value: '培训'},{feType: '4',value: '差旅'},
													   {feType: '5',value: '公务接待'},{feType: '7',value: '公务出国'} -->
										</td>
										<td class="td4">&nbsp;</td>
										<td class="td1">&nbsp;&nbsp;支出事项标准</td>
										<td class="td2">
											<input class="easyui-textbox" id="EM_feStandard" name="feStandard" data-options="validType:'length[1,20]'" value="${bean.feStandard}" style="width: 115px"/>
											&nbsp;&nbsp;&nbsp;据实列支<input type="checkbox" onclick="jslz(this)" style="margin-top: 3px;vertical-align: middle;">
										</td>
									</tr>
									<!-- 正餐费用 、早餐费用、宴请费用 -->
									<%-- <tr class="trbody" id="expenditure-recep1" style="display: none;">
									...
									<tr class="trbody" id="expenditure-recep2" style="display: none;">
									...
									<tr class="trbody" id="expenditure-travel" style="display: none;">
										<td class="td1" id="expenditure-travel-level1">&nbsp;&nbsp;城市等级</td>
										<td class="td2" id="expenditure-travel-level2">
									...
									<tr  class="trbody" id="expenditure-meeting" style="display: none;">
										...
										<td class="td2">
											<input class="easyui-combobox" style="width: 200px" value="${bean.fext2}" data-options="valueField: 'fext2',textField: 'value',editable:false,
										...
										<td class="td1">&nbsp;&nbsp;费用类型</td>
										<td class="td2">
											<input class="easyui-combobox" style="width: 200px" value="${bean.fext1}" data-options="valueField: 'fext1',textField: 'value',editable:false,
									...
									<tr style="height: 70px;" id="expenditure-role">
										...
										&nbsp;&nbsp;适用角色<br/>
										<a href="javascript:void(0)" onclick="choiceRoles();">
											<img src="${base}/resource-modality/${themenurl}/button/xuanzhe1.png" onMouseOver="mouseOver(this)" onMouseOut="mouseOut(this)" style="margin-top: 10px;">
										</a>
										</td>
										<td colspan="4">
									...
									<tr style="height: 70px;">
										...
										<td colspan="4">
											<input class="easyui-textbox" data-options="multiline:true" id="EM_feRemark" name="feRemark" style="width: 555px;height:70px;" value="${bean.feRemark}">  
			...
			<div class="win-left-bottom-div">
				<a href="javascript:void(0)" onclick="EMAddEditForm();">
	...
	$('#exp_add_type1').combobox({
		onSelect: function(rec){
			...
			if(feType==2) {//会议
				...
				$('#expenditure-recep1').css('display','none');
				$('#expenditure-recep2').css('display','none');
				...
				$('#expenditure-recep2').css('display','none');
				$('#tr_zcsxgl_add_dwj').css('display','none');
			} else if(feType==5){//公务接待
				$('#expenditure-recep1').css('display','');
				$('#expenditure-recep2').css('display','');
