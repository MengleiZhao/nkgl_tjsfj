...
<form id="cgsq_register_form" name="example" method="post" data-options="novalidate:true" class="easyui-form" enctype="multipart/form-data">
...
<script type="text/javascript">
	...
	function saveCgFileApply(type) {
		...
		//提交
		$('#cgsq_register_form').form('submit', {
			onSubmit : function() {
				//获得校验结果
