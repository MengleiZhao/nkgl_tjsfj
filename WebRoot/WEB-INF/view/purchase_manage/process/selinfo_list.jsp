...
<div >
			...
			<table class="top-table" cellpadding="0" cellspacing="0">
					<tr>
						<td class="top-table-search">
							...
							&nbsp;&nbsp;<a href="#" onclick="querySelInfo();">
								<img style="vertical-align:bottom" src="${base}/resource-modality/${themenurl}/button/detail1.png" onMouseOver="mouseOver(this)" onMouseOut="mouseOut(this)">
							</a>
							<a href="#" onclick="clearSelInfoTab();">
		...
		<div style="margin: 0 10px 0 10px;height: 250px;">	
			...
			selectOnCheck: true,checkOnSelect:true,remoteSort:true,nowrap:false,striped: true,fitColumns: true">
				<thead>
					...
					<th data-options="field:'fwCode',align:'left'" style="width: 18%">供应商编码</th>
					<th data-options="field:'fwName',align:'left'" style="width: 20%">供应商名称</th>
					<th data-options="field:'fwAddr',align:'left',resizable:false,sortable:true" style="width: 20%">办公地址</th>
					<th data-options="field:'fwuserName',align:'left',resizable:false,sortable:true" style="width: 12%">联系人</th>
					<th data-options="field:'fwTel',align:'left',resizable:false,sortable:true" style="width: 15%">联系电话</th>
					<th data-options="field:'name',align:'left',resizable:false,sortable:true,formatter:selectSupplier" style="width: 10%">操作</th>
				</tr>
				</thead>
			</table>
		</div>
		...
		$('#sel_tab').datagrid({
			 onDblClickRow:function(index, row){
				...
				if (row != null && selections.length == 1) {
				    ...
				    $("#F_fwCode").textbox('setValue',row.fwCode);
				    $("#F_fLegalRep").textbox('setValue',row.fLegalRep);
					closeFirstWindow();
				} else {
	...
	//操作栏创建
	function selectSupplier(val,row) {		
	...
	//查看
	 function supplier_detail(id) {
		var win = parent.creatWin(' ', 970, 580, 'icon-search',"/suppliergl/detail?id=" + id);
		win.window('open'); 
	}
