				...
				<div class="tab-wrapper" id="yx-tab">
					...
					<div class="tab-content">
						...
						<%-- <div title="采购申请" style="margin-bottom:35px;" data-options="iconCls:'icon-xxlb'">
							<div class="easyui-accordion" data-options="" id="" style="width:698px;margin-left: 20px">
								<!-- 第3个div -->
								<div title="采购信息" data-options="iconCls:'icon-xxlb'" style="width:698px;overflow:auto;margin-top: 10px;">
									<jsp:include page="../../purchase/cgjh_msg.jsp" />
								</div>
	
								<!-- 第4个div -->
								<div title="采购清单" data-options="iconCls:'icon-xxlb'" style="width:698px;overflow:auto;margin-top: 10px;">
