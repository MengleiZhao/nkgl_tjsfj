...
<table cellpadding="0" cellspacing="0" class="ourtable" border="0">
	<tr class="trbody">
		...
		<td colspan="4">
			<input class="easyui-textbox" id="F_fwName"  name="fwName"   style="width:555px;" data-options="" value="${fwbean.fwName}"/>
		</td>
	</tr>										
	...
	<tr>
		...
		<td class="td2">
			<input class="easyui-numberbox" id="F_fbidAmount" name="fbidAmount" data-options="icons: [{iconCls:'icon-yuan'}],precision:2" style="width: 200px" value="${br.fbidAmount}"/>
		</td>
		<td class="td4">
			<!-- 隐藏域 -->
	...
	<tr class="trbody">
		...
		<td colspan="4">
			<input class="easyui-textbox" type="text" id="F_fwAddr"  name="fwAddr"   data-options="validType:'length[1,200]'" style="width:555px;" value="${fwbean.fwAddr}"/>
		</td>
	</tr>
	...
	<tr style="height: 78px;">
		...
		<td colspan="4">
			<input class="easyui-textbox" type="text" id="F_ftendFax"  name="ftendFax"    data-options="validType:'length[1,200]',multiline:true"   style="width:555px;height:70px;" value="${br.ftendFax}"/>
		</td>
	</tr>
