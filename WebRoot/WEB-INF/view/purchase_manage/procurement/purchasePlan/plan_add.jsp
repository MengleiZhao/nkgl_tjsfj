...
<form id="purchase_plan_form" method="post" data-options="novalidate:true" class="easyui-form" enctype="multipart/form-data">
		<div class="window-left-div" style="width:760px;height: 491px;border: 1px solid #D9E3E7;margin-top: 20px;" data-options="region:'west',split:true">
					...
					<div  title="完善信息" data-options="collapsed:false,collapsible:false"
						...
						<table cellpadding="0" cellspacing="0" class="ourtable">
							...
							<tr class="trbody">
								...
								<td class="td2">
									<input class="easyui-textbox" type="text" required="required" name="agency" data-options="validType:'length[1,100]'" style="width: 200px" value="${bean.agency}"/>
								</td>
								<td class="td4">
									<!-- 隐藏域 -->
							...
							<tr class="trbody">
								...
								<td class="td2">
									<input class="easyui-combobox" required="required" id="processLeaderCombo" name="processLeaderId" data-options="editable:false,panelHeight:'auto',url:'${base}/purchasePlan/getUserByRole?selected=${bean.processLeaderId}',method:'POST',valueField:'id',textField:'text',editable:false,validType:'selectValid'" style="width: 200px" />
								</td>
								<td class="td4"></td>
								<td class="td1"></td>
								<td class="td2">
			...
			<div class="window-left-bottom-div">
				<a href="javascript:void(0)" onclick="savePurchasePlan(0)">
					<img src="${base}/resource-modality/${themenurl}/button/zhanchun1.png" onMouseOver="mouseOver(this)" onMouseOut="mouseOut(this)">
				</a>&nbsp;&nbsp;
				<a href="javascript:void(0)" onclick="savePurchasePlan(1)">
...
<script type="text/javascript">
	...
	//保存
	function savePurchasePlan(fCheckStauts) {
		
		//设置审批状态
		$('#flowStauts').val(fCheckStauts);
		
		//提交
		$('#purchase_plan_form').form('submit', {
			onSubmit : function() {
				//获得校验结果
			...
			success : function(data) {
				...
				if (data.success) {
				    ...
				    $('#purchase_plan_Tab').datagrid('reload');
					closeWindow();
				} else {
