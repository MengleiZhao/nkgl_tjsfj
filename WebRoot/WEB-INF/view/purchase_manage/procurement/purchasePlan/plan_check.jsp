...
<form id="purchase_plan_check_form" method="post" data-options="novalidate:true" class="easyui-form" enctype="multipart/form-data">
					...
					<div  title="基本信息" data-options="collapsed:false,collapsible:false"
						...
						<table cellpadding="0" cellspacing="0" class="ourtable">
							<tr class="trbody">
								...
								<td class="td2">
									<input class="easyui-textbox" type="text" readonly="readonly" name="fPurchaseName" style="width: 200px" value="${bean.fPurchaseName}"/>
								</td>
								<td class="td4"></td>
								<td class="td1"><span class="style1">*</span>&nbsp;预算金额</td>
								<td class="td2">
									<input class="easyui-textbox" type="text" readonly="readonly" id="f_amount" name="amount" style="width: 200px" value="${bean.amount}"/>
								</td>
							</tr>
							<tr class="trbody">
...
<script type="text/javascript">
	...
	function check(checkResult) {
	 	...
	 	$('#purchase_plan_check_form').form('submit', {
			onSubmit : function() {
				$.messager.progress();
			},
			url : base + '/purchasePlanCheck/checkResult',
			success : function(data) {
				$.messager.progress('close');
				data = eval("(" + data + ")");
				if (data.success) {
					$.messager.alert('系统提示', data.info, 'info');
					$('#purchase_plan_check_Tab').datagrid('reload');
