...
<body>
<div class="win-div">
<form id="expert_check_form" method="post" data-options="novalidate:true" class="easyui-form" enctype="multipart/form-data">
						...
						<table cellpadding="0" cellspacing="0" class="ourtable" border="0">
							<tr class="trbody">
								...
								<td class="td2">
									...
									<input type="hidden" name=fuserName value="${ebean.userName2}" /><!--当前审批人姓名  -->
									<input type="hidden" name="fuserId" value="${ebean.userId}" /><!--当前审批人id  -->
									<input type="hidden" name="nCode" value="${ebean.nCode}" /><!--当前审批节点  -->
									<input type="hidden" name="fexpertSex" value="${ebean.fexpertSex}" /><!--性别  -->
									<input type="hidden" name="fisGpw" value="${ebean.fisGpw}" /><!--是否高评委建库单位人员  -->
									<input type="hidden" name="faccFreq" value="${ebean.faccFreq}" /><!--专家库的拉黑次数  -->
							...
							<tr>
								...
								<td class="td2">
									<input class="easyui-textbox" type="text" id="F_feducation"  name="feducation"  readonly="readonly" data-options="validType:'length[1,20]'" style="width: 200px" value="${ebean.feducation}"/>
								</td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td class="td2">
									<input class="easyui-textbox"  id="F_ffield"  name="ffield" readonly="readonly" required="required" data-options="validType:'length[1,200]'" style="width: 200px;" value="${ebean.ffield}"/>
								</td>
								<td class="td4"></td>
							...
							<tr class="trbody">
								...
								<td class="td2" colspan="4">
									<input class="easyui-textbox"  id="F_fhomeAddr"  name="fhomeAddr" readonly="readonly"  data-options="validType:'length[1,50]'" style="width: 555px;" value="${ebean.fhomeAddr}"/>
								</td>
							</tr>
							<tr style="height: 78px;">
								...
								<td colspan="4">
									<input class="easyui-textbox" type="text" id="F_fremark"  name="fremark" readonly="readonly"  data-options="validType:'length[1,50]',multiline:true"   style="width:555px;height:70px;" value="${ebean.fremark}"/>
												...
												<!-- 第2个div -->
					<div title="专家审批记录" data-options="iconCls:'icon-xxlb'" style="overflow:auto;margin-top: 10px;">
					  		<jsp:include page="expert_check_history.jsp" />												
					</div>
	...
	function check(checkResult) {
	 		$('#expert_check_form').form('submit', {
				...
				url : base + '/expertcheck/checkExpert?type=in',
				success : function(data) {
					...
					if (data.success) {
						...
						closeWindow();
						//$('#expert_check_form').form('clear');
						$('#check_expert_tab').datagrid('reload'); 
