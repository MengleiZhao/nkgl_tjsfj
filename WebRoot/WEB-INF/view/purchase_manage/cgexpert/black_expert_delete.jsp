...
<body>
<div >
<form id="expert_black_delete_form" method="post" data-options="novalidate:true" class="easyui-form" enctype="multipart/form-data">
	...
	function saveBlackExpert() {
		 //提交
		$('#expert_black_delete_form').form('submit', {
			onSubmit : function() {
			...
			success : function(data) {
				...
				if (data.success) {
					...
					closeWindow();
					//$("#expert_black_delete_form").form("clear");
					 $("#white_expert_tab").datagrid("reload");
				} else {
