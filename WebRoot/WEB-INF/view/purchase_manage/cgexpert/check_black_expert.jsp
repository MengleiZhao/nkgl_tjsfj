...
<form id="expert_check_form" method="post" data-options="novalidate:true" class="easyui-form" enctype="multipart/form-data">
						...
						<table cellpadding="0" cellspacing="0" class="ourtable" border="0">
							<tr class="trbody">
								...
								<td class="td2">
									...
									<input type="hidden" name="feId" id="F_feId" value="${bean.feId}"/><!--隐藏域  -->
									<input type="hidden" name="feBId" id="F_feBId" value="${bean.feBId}"/><!--隐藏域  -->
									<input type="hidden" name="fCheckStatus" id="F_fCheckStatus" value="${bean.fCheckStatus}"/><!--专家黑名单申请的审批状态  -->
									...
									<input type="hidden" name="faccFreq" value="${ebean.faccFreq}" /><!--供应商的拉黑次数  -->
									<!-- 审批结果 -->
	...
	function check(checkResult) {
	 		$('#expert_check_form').form('submit', {
				...
				url : base + '/expertcheck/checkExpert?type=black',
