...
<form id="cgapply_check_form" method="post" data-options="novalidate:true" class="easyui-form" enctype="multipart/form-data">
		<div class="window-left-div" style="width:750px;height: 491px;border: 1px solid #D9E3E7;margin-top: 20px;" data-options="region:'west',split:true">
			<div class="win-left-top-div">
				<div class="easyui-accordion" data-options="" id="" style="width:682px;margin-left: 20px">
					<div  title="采购项目签报表" id="cgxxdiv" data-options="collapsed:false,collapsible:false"
								...
								<table cellpadding="0" cellspacing="0" class="ourtable">
									...
									<tr >
										<td colspan="5">
											<textarea id="proSignContentCheck" readonly="readonly" style="width:670px;height:800px;"></textarea>
										</td>
									</tr>
								</table>
							</div>
						...
						<table cellpadding="0" cellspacing="0" class="ourtable">
							...
							<tr class="trbody">
								...
								<td class="td2">
         							<input type="radio" name="fIsImp" disabled="disabled" <c:if test="${bean.fIsImp=='1'}">checked="checked"</c:if> value="1">是
         							<input type="radio" name="fIsImp" disabled="disabled" <c:if test="${bean.fIsImp!='1'}">checked="checked"</c:if> value="0">否
								</td>
								<td class="td4"></td>
								<td class="td1"><span class="style1">*</span>&nbsp;涉密采购</td>
								<td class="td2">
         							<input type="radio" name="fIsPers" disabled="disabled" <c:if test="${bean.fIsPers=='1'}">checked="checked"</c:if> value="1">是
         							<input type="radio" name="fIsPers" disabled="disabled" <c:if test="${bean.fIsPers!='1'}">checked="checked"</c:if> value="0">否
								</td>
							</tr>
					...
					<c:if test="${bean.amount>=200000 }">
						<div title="党委会会议号" id="cgdwhdiv" data-options="collapsed:false,collapsible:false" style="overflow-x:hidden;margin-top: 10px;">
							<table cellpadding="0" cellspacing="0" class="ourtable" style="margin-top: 10px;margin-left: -10px">
								<tr>
									<td class="td1"><span class="style1">*</span>&nbsp;编号:</td>
									<td colspan="4">
										<input class="easyui-textbox" id="f_cgdwh" name="fDZHCode" style="width: 200px;" data-options="" value="${bean.fDZHCode }" readonly="readonly"/>
									</td>
								</tr>
								<tr class="trbody">
									<td class="td1">
...
function check(checkResult) {
	if(checkResult == 1){
		if(djhCode==1 && amountValue >= 200000){
...
<script type="text/javascript">
  ...
  var ue = UE.getEditor('proSignContentCheck');
  
//对编辑器的操作最好在编辑器ready之后再做
ue.ready(function() {
 var proSignContentCheck ='${beanCopy.proSignContent}';
    //设置编辑器的内容
    if(proSignContentCheck==''){
   	 ue.setContent('');
    }else{
    	ue.setContent(proSignContentCheck);
    }
    ue.setDisabled();
});
