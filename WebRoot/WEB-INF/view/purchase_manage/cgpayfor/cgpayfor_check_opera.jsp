...
<body>
<div class="win-div">
<form id="cgpayfor_check_opera_form" method="post" data-options="novalidate:true" class="easyui-form" enctype="multipart/form-data">
	<div class="easyui-layout" style="height: 509px;">
		<div class="win-left-div" data-options="region:'west',split:true">
								...
								<div title="供应商信息" data-options="iconCls:'icon-xxlb'" style="overflow:auto;margin-top: 10px;">
									<table cellpadding="0" cellspacing="0" class="ourtable" border="0">
										...
										<tr style="height: 70px;">
											...
											<td colspan="4">
												<input class="easyui-textbox" type="text" id="F_fwRemark"  name="fwRemark" readonly="readonly" data-options="validType:'length[1,500]',multiline:true"   style="width:555px;height:70px;" value="${fwbean.fwRemark}"/>
											</td>
										</tr>
									</table>
								</div>
								 ...
								 <div title="验收记录" data-options="iconCls:'icon-xxlb'" style="overflow:auto;margin-top: 10px;">
 							  		<table cellpadding="0" cellspacing="0" class="ourtable" border="0">
										...
										<tr class="trbody">
											...
											<td colspan="4">
												<input class="easyui-textbox" type="text" id="F_facpAddr"  name="facpAddr" readonly="readonly" required="required" data-options="validType:'length[1,200]'" style="width: 555px" value="${historybean.facpAddr}"/>
											</td>
										</tr>
										<tr style="height: 70px;">
											<td class="td1" valign="top"><p style="margin-top: 8px">质量说明</p></td>
											<td class="td2" colspan="4">
												<input class="easyui-textbox" type="text" id="F_fqualityRemark" readonly="readonly"  name="fqualityRemark" data-options="validType:'length[1,500]',multiline:true"   style="width:555px;height:70px;" value="${historybean.fqualityRemark}"/>
											</td>
										</tr>
										<tr style="height: 70px;">
											<td class="td1" valign="top"><p style="margin-top: 8px">验收说明</p></td>
											<td class="td2" colspan="4">
												<input class="easyui-textbox" type="text" id="F_fmatchRemark" readonly="readonly"  name="fmatchRemark" data-options="validType:'length[1,500]',multiline:true"   style="width:555px;height:70px;" value="${historybean.fmatchRemark}"/>
											</td>
										</tr>
										<tr class="trbody">
											<td class="td1">附件</td>
			...
			<div class="win-left-bottom-div">
				<a href="javascript:void(0)" onclick="savePayApply(1)">
	...
	//送审
	function savePayApply(fpayStauts) {
		//设置付款的审批状态
		$('#F_fpayStauts').val(fpayStauts);
		//提交
		$('#cgpayfor_check_opera_form').form('submit', {
			onSubmit : function() {
			...
			success : function(data) {
				...
				if (data.success) {
					...
					closeWindow();
					//$("#cgpayfor_check_opera_form").form("clear");
					 $("#cg_payfor_receive_tab").datagrid("reload");
