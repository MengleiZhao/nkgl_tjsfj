...
<div class="list-div">
	...
	<div class="list-top">
		<table id="cg_answerCheck_dg" class="top-table" cellpadding="0" cellspacing="0">
			<tr>
	...
	<div style="margin: 0 10px 0 10px;height: 445px;">	
		<table id="cg_answerCheck_dg" class="easyui-datagrid"
			data-options="collapsible:true,url:'${base}/cgAsk/answerCheckPage',
...
function queryCgApply() {
	...
	$('#cg_answerCheck_dg').datagrid('load', {
...
function clearCgApply() {
	...
	$('#cg_answerCheck_dg').datagrid('load',{//清空以后，重新查一次
	});
}
...
function CZ(val,row){
	...
	if (c == 9) {
		...
		return 	'<table><tr style="width: 75px;height:20px"><td style="width: 25px">'+
				...
				'<a href="#" onclick="checkAnswer(' + row.fqId + ')" class="easyui-linkbutton">'+
...
function checkAnswer(id) {
	var win = creatWin('审批', 1080, 580, 'icon-search', '/cgAsk/check?id='+id);
	win.window('open');
}
</script>
</body>
