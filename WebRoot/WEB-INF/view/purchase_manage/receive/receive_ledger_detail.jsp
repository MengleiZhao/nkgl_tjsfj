			...
			<div class="win-left-top-div">
				<div class="tab-wrapper" id="yx-tab">
					...
					<div class="tab-content">
						...
						<%-- <!--第7个div  -->
						<div title="评价信息" data-options="iconCls:'icon-xxlb'" style="overflow:auto;margin-bottom:35px;">
							<div class="easyui-accordion" data-options="" id="" style="width:662px;margin-left: 20px">
...
<script type="text/javascript"> 
	...
	$(function() {		
	 ...
	 function see_Eval_Supplier(){
		var fpid = $('#F_fcId').val();
		var win = creatWin('评价', 970, 580, 'icon-search', "/evalsupplier/seeEvalSupplier?id="+ fpid);
		win.window('open');	 
	 }
</script>
</body>