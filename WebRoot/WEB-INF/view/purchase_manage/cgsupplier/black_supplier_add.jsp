...
<body>
<div class="win-div">
<form id="supplier_black_add_form" method="post" data-options="novalidate:true" class="easyui-form" enctype="multipart/form-data">
					...
					<table cellpadding="0" cellspacing="0"  border="0">
						...
						<tr style=" width: 430px;height: 70px;">
							<td colspan="4">
								...
								<%-- <input class="easyui-textbox" type="text" id="F_fblackDesc" required="required" name="fblackDesc"  data-options="prompt: '200字以内' ,validType:'length[1,200]',multiline:true"   style="width:430px;height:70px;" value="${bean.fblackDesc}"/> --%>
	...
	function saveBlackSupplier() {
		 //提交
		$('#supplier_black_add_form').form('submit', {
			onSubmit : function() {
			...
			success : function(data) {
				...
				if (data.success) {
					...
					closeFirstWindow();
					closeWindow();
					//$("#supplier_black_add_form").form("clear");
