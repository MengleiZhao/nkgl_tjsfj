...
<div class="list-div">
	...
	<div class="list-top">
		...
		<div style="margin: 0 10px 0 10px;height: 445px;">	
			<table id="black_supplier" class="easyui-datagrid"
				data-options="collapsible:true,url:'${base}/suppliergl/whitesupPage?fwRemark=black',
			...
			selectOnCheck: true,checkOnSelect:true,remoteSort:true,nowrap:false,striped: true,fitColumns: true">
				<thead>
					<tr>
						...
						<th data-options="field:'fisBlackStatus',align:'left',resizable:false,sortable:true,formatter:formatStauts" style="width: 10%">是否黑名单</th>
						<th data-options="field:'operation',align:'left',formatter:format_black" width="8%">操作</th>
					</tr>
				</thead>
			</table>
		</div>
	...
	function formatStauts(val, row) {
		...
		if (c == 0) {
			...
			return '<a style="color:#666666;"><img src="'+base+'/resource-modality/${themenurl}/ytg.png">' + " 是" + '</a>';
		}else{
	...
	function IN_BLACK(id) {
		var win =parent.creatWin(' ', 810, 580, 'icon-search',"/blacksuppliergl/inblack?id=" + id);
		win.window('open'); 
  	}
	</script>
</body>
