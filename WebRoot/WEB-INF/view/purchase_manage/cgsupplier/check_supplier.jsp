...
<form id="supplier_check_form" method="post" data-options="novalidate:true" class="easyui-form" enctype="multipart/form-data">
									...
									<table cellpadding="0" cellspacing="0" class="ourtable" border="0">
										<tr class="trbody">
											...
											<td colspan="4">
												...
												<input type="hidden" name=fuserName value="${fwbean.userName2}" /><!--当前审批人姓名  -->
												<input type="hidden" name="fuserId" value="${fwbean.userId}" /><!--当前审批人id  -->
												<input type="hidden" name="nCode" value="${fwbean.nCode}" /><!--当前审批节点  -->
												<input type="hidden" name="fisBlack" value="${fwbean.fisBlack}" /><!--是否黑名单  -->
												<input type="hidden" name="fstauts" value="${fwbean.fstauts}" /><!--数据的删除状态  -->
												<input type="hidden" name="faccFreq" value="${fwbean.faccFreq}" /><!--供应商的拉黑次数  -->
	...
	function check(checkResult) {
	 		$('#supplier_check_form').form('submit', {
				...
				url : base + '/suppliercheck/checkSupplier',
