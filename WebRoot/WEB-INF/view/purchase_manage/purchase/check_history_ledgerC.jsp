...
<div class="window-tab" style="margin-left: 0px;padding-top: 10px">
	...
	<table id="check-history-ledgerC" class="easyui-datagrid"  style="width:695px;height:auto"
	data-options="
	<c:if test="${empty foCodeC}">
	url: '',
	</c:if>
	<c:if test="${!empty foCodeC}">
	url: '${base}/wflow/history?fpId=${fpIdC}&foCode=${foCodeC}',
	</c:if>
	method: 'post'
	">
	<thead>
