...
<div class="window-tab" style="margin-left: 0px;padding-top: 10px">
	...
	<table id="check-history-ledgerT" class="easyui-datagrid"  style="width:695px;height:auto"
	data-options="
	<c:if test="${empty foCodeT}">
	url: '',
	</c:if>
	<c:if test="${!empty foCodeT}">
	url: '${base}/wflow/history?fpId=${fpIdT}&foCode=${foCodeT}',
	</c:if>
	method: 'post'
	">
	<thead>
