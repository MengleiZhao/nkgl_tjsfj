...
<div class="window-tab" style="margin-left: 0px;padding-top: 10px">
	<table id="check-history-ledgerA" class="easyui-datagrid"  style="width:695px;height:auto"
	data-options="
	<c:if test="${empty foCodeApply}">
	url: '',
	</c:if>
	<c:if test="${!empty foCodeApply}">
	url: '${base}/wflow/history?fpId=${fpIdApply}&foCode=${foCodeApply}',
	</c:if>
	method: 'post'
	">
	<thead>
