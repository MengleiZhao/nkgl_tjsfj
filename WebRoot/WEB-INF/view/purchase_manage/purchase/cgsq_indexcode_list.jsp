		...
		selectOnCheck: true,checkOnSelect:true,remoteSort:true,nowrap:false,striped: true,fitColumns: true">
			<thead>
				<tr>
					...
					<th data-options="field:'fpName',align:'left',resizable:false,sortable:true" style="width: 15%">采购名称</th>
					<th data-options="field:'fpAmount',align:'left',resizable:false,sortable:true" style="width: 15%">采购金额[元]</th>
...
<script type="text/javascript">
	...
	function CZ(val, row) {
		...
		var button2='<td style="width: 25px">'+
			'<a href="#" onclick="contract_detail(' + row.contractId + ')" class="easyui-linkbutton">'+
		...
		function contract_detail(id) {
			var win = creatWin('合同信息', 970, 580, 'icon-search',"/Formulation/detail/" + id);
			win.window('open');
		}
