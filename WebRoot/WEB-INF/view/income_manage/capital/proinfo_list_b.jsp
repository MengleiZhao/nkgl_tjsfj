...
<div class="easyui-layout" fit="true">
	...
	<div data-options="region:'south'" style="text-align: center;">
		<a href="javascript:void(0)" onclick="checkB()">
	...
	function format_oper(val, row) {
			return '<table><tr style="width: 75px;height:20px"><td style="width: 25px">'+
				   '<a href="#" onclick=checkB("'+ row.fproCode +'","'+row.fproName+'") class="easyui-linkbutton">'+ 
	...
	//选择 选中数据  
		function checkB() {
			...
			$("#F_fproName2").textbox('setValue', name);
			$("#F_fproCode2").val(code);
			closeFirstWindow();
