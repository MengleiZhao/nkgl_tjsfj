...
<div class="easyui-layout" fit="true">
			...
			selectOnCheck: true,checkOnSelect:true,remoteSort:true,nowrap:false,striped: true,fitColumns: true">
				<thead>
					<tr>
						...
						<th data-options="field:'typeName',align:'center'" width="10%">项目类型</th>
	...
	<div data-options="region:'south'" style="text-align: center;">
		<a href="javascript:void(0)" onclick="checkA()">
	...
	function format_oper(val, row) {
			return '<table><tr style="width: 75px;height:20px"><td style="width: 25px">'+
				   '<a href="#" onclick=checkA("'+ row.fproCode +'","'+row.fproName+'") class="easyui-linkbutton">'+ 
	...
	//选择 选中数据  
		function checkA(code,name) {
			...
			$("#F_fproName").textbox('setValue', name);
			$("#F_fproCode").val(code);
			closeFirstWindow();
