...
<form id="income-goldpay-detail" action="${base}/Dispute/Save" method="post" data-options="novalidate:true" class="easyui-form" enctype="multipart/form-data">
							...
							<table class="window-table" cellspacing="0" cellpadding="0" style="margin-top: 3px;">
								<tr class="trbody">
									...
									<td class="td2">
										...
										data-options="" value="${goldPay.fpayedDate}" readonly="readonly" editable="false"/>
									</td>
								</tr>
							</table>
						</div>				
