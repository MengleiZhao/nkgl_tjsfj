	...
	<div class="window-div">
		<div class="window-left-div" style="width:765px;height: 491px;border: 1px solid #D9E3E7;margin-top: 20px;">
				...
				<div title="收款录入" data-options="collapsed:false,collapsible:false"
					...
					<table class="window-table" cellspacing="0" cellpadding="0" style="margin-top: 3px;width:707px;padding-left: 3px;">
						<tr class="trbody">
									...
									<td class="td1" style="width: 200px"><span class="style1">*</span>政府支出经济分类</td>
									<td class="td2">
										<input id="fSubCode" name="fSubCode" class="easyui-combobox" data-options="validateOnCreate:false,editable:false,panelHeight:'auto',url:'${base}/quotaManage/lookupsJson?blanked=0&selected=${bean.fSubCode}',method:'POST',valueField:'code',textField:'text',editable:false,validType:'selectValid',onSelect:onSelectSub"
								...
								<tr>
									...
									<td class="td2" colspan="4">
										<input id="fAmount" name="fAmount" class="easyui-numberbox" required="required"  style="width: 200px;height: 30px" value="${bean.fAmount}"/>
									</td>
								</tr>
							</table>
				</div>
			...
			<div class="window-left-bottom-div">
				<a href="javascript:void(0)" onclick="saveRegist(0)">
				<img src="${base}/resource-modality/${themenurl}/button/zhanchun1.png" onMouseOver="mouseOver(this)" onMouseOut="mouseOut(this)">
				</a>&nbsp;&nbsp;
				<a href="javascript:void(0)" onclick="saveRegist(1)">
