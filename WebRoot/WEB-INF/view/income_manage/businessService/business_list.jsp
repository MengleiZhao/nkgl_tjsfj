...
function add_business() {
	var win = creatWin('新增', 970, 580, 'icon-search', '/business/add');
	win.window('open');
}

//修改
function update_business(id) {
	var win = creatWin('修改', 970, 580, 'icon-search', '/business/edit?id=' + id);
	win.window('open');
}

//查看
function detail_business(id) {
	var win = creatWin('查看', 970, 580, 'icon-search', '/business/detail?id=' + id);
	win.window('open');
} 
