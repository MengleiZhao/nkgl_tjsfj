...
.xl97
 ...
 <body link="blue" vlink="purple">
  <table width="1037" border="0" cellpadding="0" cellspacing="0" style='width:777.75pt;border-collapse:collapse;table-layout:fixed;'>
   <col width="125" style='mso-width-source:userset;mso-width-alt:4320;'/>
   <col width="120" style='mso-width-source:userset;mso-width-alt:4736;'/>
   <col width="78" style='mso-width-source:userset;mso-width-alt:2816;'/>
   <col width="120" style='mso-width-source:userset;mso-width-alt:4480;'/>
   <col width="52" style='mso-width-source:userset;mso-width-alt:2304;'/>
   <col width="70" span="2" style='mso-width-source:userset;mso-width-alt:3456;'/>
   <col width="20" style='mso-width-source:userset;mso-width-alt:640;'/>
   <col width="188" style='mso-width-source:userset;mso-width-alt:6976;'/>
   ...
   <tr height="92" style='height:69.00pt;mso-height-source:userset;mso-height-alt:1380;'>
    <td class="xl66" height="92" colspan="9" style='height:69.00pt;border-right:none;border-bottom:none;' x:str><span style='mso-spacerun:yes;'>&nbsp;</span><font class="font2">天津市司法局来款登记申请</font></td>
   </tr>
   <tr height="53.33" style='height:40.00pt;mso-height-source:userset;mso-height-alt:800;'>
    <td class="xl67" height="53.33" style='height:40.00pt;' x:str></td>
    <td class="xl68"></td>
    <td class="xl67"></td>
    <td class="xl67"></td>
    <td class="xl70" colspan="3" style='border-right:none;border-bottom:none;' x:str>单据编号：</td>
    <td class="xl70" x:str>${bean.registerCode}</td>
   </tr>
   <tr height="53.33" style='height:40.00pt;mso-height-source:userset;mso-height-alt:800;'>
    <td class="xl67" height="53.33" style='height:40.00pt;' x:str>登记日期：</td>
    <td class="xl68"><fmt:formatDate value="${bean.reqTime}" pattern="yyyy年MM月dd日"/></td>
    <td class="xl67"></td>
    <td class="xl67"></td>
    <td class="xl69"></td>
    <td class="xl69"></td>
    <td class="xl70" colspan="2" style='border-right:none;border-bottom:none;' x:str></td>
    <td class="xl70" x:str></td>
   </tr>
   <tr height="53.33" style='height:40.00pt;mso-height-source:userset;mso-height-alt:800;'>
    <td class="xl71" height="53.33" style='height:40.00pt;' x:str>登记人姓名</td>
    <td class="xl72" colspan="3" style='border-right:1pt solid windowtext;border-bottom:.5pt solid windowtext;'>${bean.userName}</td>
    <td class="xl71" colspan="2" height="53.33" style='height:40.00pt;' x:str>部门（处室）</td>
    <td class="xl72" colspan="3" style='border-right:1pt solid windowtext;border-bottom:.5pt solid windowtext;'>${bean.deptName}</td>
   </tr>
   <tr height="53.33" style='height:40.00pt;mso-height-source:userset;mso-height-alt:800;'>
    <td class="xl71" height="53.33" style='height:40.00pt;' x:str>来往款项名称</td>
   ...
   <tr height="34.67" style='height:26.00pt;mso-height-source:userset;mso-height-alt:520;'>
    <td class="xl76" height="34.67" colspan="9" style='height:26.00pt;border-right:1.0pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str><b>来往明细</b></td>
   </tr>
   <tr height="53.33" style='height:40.00pt;mso-height-source:userset;mso-height-alt:800;'>
    ...
    <td class="xl77" colspan="2" x:str>预计来款日期</td>
    <td class="xl78" colspan="3" style='border-right:1.0pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>开票种类</td>
   </tr>
   ...
   <tr height="53.33" style='height:40.00pt;mso-height-source:userset;mso-height-alt:800;'>
    ...
    <td class="xl79"><fmt:formatNumber groupingUsed="true" value="${list.planMoney}" minFractionDigits="2" maxFractionDigits="2"/></td>
    ...
    <td class="xl77" colspan="2"><fmt:formatDate value="${list.planTime }" pattern="yyyy-MM-dd"/></td>
    <td class="xl78" colspan="3" style='border-right:1.0pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>
   ...
   <tr height="53.33" style='height:40.00pt;mso-height-source:userset;mso-height-alt:800;'>
    ...
    <td class="xl78" colspan="3" style='border-right:1.0pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>□发票/□收据/□其他</td>
   </tr>
   </c:if>
   
   <td class="xl79" height="277.33" rowspan="6" style='height:208.00pt;border:.5pt solid windowtext' x:str>审签</td>
    <c:forEach items="${listTProcessChecks}" var="check">
	   <tr height="33.27" style='height:52pt;mso-height-source:userset;mso-height-alt:499;'>
	    <td class="xl79" height="133.07" colspan="2" rowspan="2" style='height:69.80pt;border-right:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>${check.fRoleName }</td>
	    <td class="xl79" colspan="6" rowspan="1" style='border-right:.5pt solid windowtext;border-bottom: none'>${check.fcheckRemake }</td>
	   </tr>
	   <tr height="33.27" style='height:52pt;mso-height-source:userset;mso-height-alt:499;'>
	    <td class="xl75" colspan="6" style='border-right:.5pt solid windowtext;border-bottom:.5pt solid windowtext;border-top: none' x:str>
	    <c:if test="${!empty check.fuserId}">
	    <span style='mso-spacerun:yes;'><img style="vertical-align:bottom;width: 150px; height: 60px;margin-bottom: 5px"  src="${base}/attachment/downloadQZ/${check.fuserId}"/></span><fmt:formatDate value="${check.fcheckTime }" pattern="yyyy年MM月dd日"/>
	    </c:if>
	    <c:if test="${empty check.fuserId}">
