...
<table class="window-table" cellspacing="0" cellpadding="0">
	...
	<tr class="trbody">
		<td class="td1">收款人</td>
		<td class="td2">
			<input class="easyui-textbox" required="required" style="width: 200px;  height: 30px;" value="${bean.userName}" readonly="readonly"/>
		</td>
		
		<td class="td1">付款方式</td>
		<td class="td2">
			<select id="paymentType" class="easyui-combobox" required="required" name="paymentType" style="width: 200px; height: 30px;" editable="false">
	...
	<tr class="trbody" id="bank-info1">
		...
		<td class="td2">
			<input class="easyui-textbox" required="required" style="width: 200px; height: 30px;" id="bankAccount" name="bankAccount" value="${payee.bankAccount}" data-options="validType:'BankCardID'"/>
		</td>
		<td class="td1">开户行</td>
		<td class="td2">
	...
	<tr class="trbody" >
		...
		<td class="td2" colspan="3">
			<input class="easyui-textbox" required="required" style="width: 200px;  height: 30px;" id="payeeIdCard" name="payeeIdCard" value="${payee.payeeIdCard}"/>
		</td>
	</tr>
