	...
	<div class="window-div">
			...
			<div id="sqsqjbxx" style="overflow:auto;">					
				<div class="easyui-accordion" style="margin-left: 20px;margin-right: 20px;margin-top: 40px">
					<div title="还款信息" data-options="collapsed:false,collapsible:false"style="overflow:auto;">			
						<table class="window-table" cellspacing="0" cellpadding="0">							
							...
							<c:if test="${!empty reimbList}">							
								...
								<td class="window-table-td2">				
									<input class="easyui-textbox" id="totalCxAmount" name="totalCxAmount" readonly="readonly" style="width: 200px; height: 30px;" data-options="precision:2,icons: [{iconCls:'icon-yuan'}]"
