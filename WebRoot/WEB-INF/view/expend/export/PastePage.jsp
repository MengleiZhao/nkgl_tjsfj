  ...
  <body>
	 <table width="648" border="0" cellpadding="0" cellspacing="0" style='width:486.00pt;border-collapse:collapse;table-layout:fixed;'>
	   ...
	   <tr height="18" style='height:13.50pt;'>
	    <td class="xl65" height="882" width="648" colspan="9" rowspan="49" style='height:661.50pt;width:486.00pt;border-right:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>发票粘贴单</td>
	   </tr>
	   <tr height="18" style='height:13.50pt;'/>
	   <tr height="18" style='height:13.50pt;'/>
	   <tr height="18" style='height:13.50pt;'/>
	   ...
	   <tr height="18" style='height:13.50pt;'>
	    <td height="18" colspan="5" style='height:13.50pt;mso-ignore:colspan;'></td>
	    <td class="xl66" colspan="4" style='border-right:none;border-bottom:none;' x:str>总计金额：<font class="font0"><span style='mso-spacerun:yes;'><fmt:formatNumber groupingUsed="true" value="${amount}" minFractionDigits="2" maxFractionDigits="2"/></span></font><font class="font0">元</font></td>
	   </tr>
