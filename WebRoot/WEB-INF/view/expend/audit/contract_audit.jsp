...
//加载tab页
flashtab('contract-enforcing-audit');	
...
function check(result) {
	...
	$('#contractReimbAuditResult').val(result);
	...
	$('#contract_reimburse_check_form').form('submit', {
		...
		url : base + '/audit/contractAuditResult?payId='+payId,
...
<div class="win-div">
<form id="contract_reimburse_check_form" method="post" data-options="novalidate:true" class="easyui-form" enctype="multipart/form-data">
	<div class="easyui-layout" style="height: 509px;">
			...
			<div class="win-left-top-div">
	    		...
	    		<div class="tab-wrapper" id="contract-enforcing-audit">
						<ul class="tab-menu">
