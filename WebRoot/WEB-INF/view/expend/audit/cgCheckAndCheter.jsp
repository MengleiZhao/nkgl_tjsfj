...
<div class="easyui-tabs">
	<div title="审批流程">
		...
		<c:forEach items="${nodeConf}" var="li" varStatus="i">
			...
			<table style="background-color: #f0f5f7;width: 175px;font-size: 12px;color: #666666"
				cellpadding="0" cellspacing="0" 
				onMouseOver="spOver(this,'${li.checkInfo.fcheckResult}a',${li.FNType})"
				onMouseOut="spOut(this)" title="${li.checkInfo.fcheckRemake}">
				<tr>
					<td rowspan="4" align="center" style="width: 35px;background-color: #ffffff">
		...
		<table style="background-color: #f0f5f7;width: 175px;font-size: 12px;color: #666666"
			...
			<tr>
				...
				<td colspan="2" style="padding-top: 6px;height: 18px">&nbsp;&nbsp;${bean.fUserName}</td>
				<td rowspan="4">
