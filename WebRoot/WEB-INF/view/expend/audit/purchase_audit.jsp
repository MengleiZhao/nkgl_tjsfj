...
<body>
<div class="win-div">
<form id="purchase_audit_form" method="post" data-options="novalidate:true" class="easyui-form" enctype="multipart/form-data">
...
function check(result) {
	...
	$('#purchase_audit_form').form('submit', {
		onSubmit : function() {
		...
		url : base + '/audit/purchaseAuditResult',
		success : function(data) {
			if (flag) {
			...
			if (data.success) {
				...
				closeWindow();
				$('#purchase_audit_form').form('clear');
