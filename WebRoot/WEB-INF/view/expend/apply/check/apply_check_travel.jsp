...
<div class="window-div">
		...
		<div class="window-left-div" style="width:765px;height: 491px;border: 1px solid #D9E3E7;margin-top: 20px;">
			<div class="win-left-top-div" >
				...
				<div id="officialTravelId" <c:if test="${bean.travelType=='GWCX' }"> hidden="hidden"</c:if> >
				<!-- 出差人员名单 -->
				<div class="easyui-accordion" style="margin-left: 20px;margin-right: 20px">
				...
				<div class="easyui-accordion" style="margin-left: 20px;margin-right: 20px;margin-top: 40px">
					<div title="费用明细" data-options="collapsible:false" style="overflow:auto;">
						...
						<div style="overflow:auto;">
							<jsp:include page="../add/apply_outside_traffic_detail.jsp" />
						</div>
						<!-- 市内交通费 -->
						<div style="overflow:auto;margin-top: 20px;">
							<jsp:include page="../add/apply_in_city_detail.jsp" />
						</div>
						<!-- 住宿费 -->
						<div style="overflow:auto;margin-top: 20px;">
							<jsp:include page="../add/hotelExpense_detail.jsp" />
						</div>
						<div style="overflow:auto;margin-top: 20px;">
							<jsp:include page="../add/foodAllowance_detail.jsp" />
						</div>
						<div style="overflow:auto;margin-top: 20px;">
				...
				<div id="officialTripId" <c:if test="${bean.travelType=='GWCC' }"> hidden="hidden"</c:if>>
				<!-- 出差人员名单 -->
				<div class="easyui-accordion" style="margin-left: 20px;margin-right: 20px;width: 717px">
					<div title="行程清单" data-options="collapsed:false,collapsible:false" style="overflow:auto;">
					<div style="overflow:auto;margin-top: 0px;">
						<jsp:include page="../add/apply_travel_itinerary_trip_detail.jsp" />
					</div>
					</div>
				</div>
				<!-- 费用明细 -->
				<div class="easyui-accordion" style="margin-left: 20px;margin-right: 20px;margin-top: 40px;width: 717px">
					<div title="费用明细" data-options="collapsible:false" style="overflow:auto;">
						<!-- 市内交通费 -->
						<div style="overflow:auto;margin-top: 20px;">
							<jsp:include page="../add/apply_in_city_trip_detail.jsp" />
						</div>
						<div style="overflow:auto;margin-top: 20px;">
							<jsp:include page="../add/foodAllowance_trip_detail.jsp" />
						</div>
						<!-- 住宿费 -->
						<div style="overflow:auto;margin-top: 20px;">
							<jsp:include page="../add/hotelExpense_trip_detail.jsp" />
						</div>
						<div style="margin-top: 20px">
							<a style="float: right;">申请金额总计：<span style="color: #D7414E"  id="applyTotalAmountTrip"><fmt:formatNumber groupingUsed="true" value="${bean.amount}" minFractionDigits="2" maxFractionDigits="2"/>[元]</span></a>
						</div>
					</div>
				</div>
				</div>
