...
data-options="
url: '${base}/checkHistory/history?id=${bean.gId}&type=apply',
method: 'post',
striped : true,
nowrap : true,
rownumbers:true,
...
<thead>
	<tr>
		<th data-options="field:'fuserName',required:'required',align:'center',width:50">审批人</th>
		...
		<th data-options="field:'fcheckRemake',required:'required',align:'center',width:290,formatter:formatCellTooltip">审批内容</th>
	</tr>
</thead>
