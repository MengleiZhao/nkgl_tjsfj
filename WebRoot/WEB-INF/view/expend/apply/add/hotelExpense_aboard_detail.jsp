	...
	">
		<thead>
			<tr>
				...
				<th data-options="field:'checkInTime',width:100,align:'center',editor:{type:'datebox', options:{editable:false,onChange:hotelStartTime}},formatter:ChangeDateFormat1" >入住时间</th>
				<th data-options="field:'checkOUTTime',width:100,align:'center',editor:{type:'datebox',options:{editable:false,onChange:hotelEndTime}},formatter:ChangeDateFormat1" >退房时间</th>
				...
				<th data-options="field:'applyAmount',align:'center',width:100,editor:{type:'numberbox',options:{editable:true,precision:2,onChange:hotelAmounts}}">申请费用</th>
			</tr>
		</thead>
	</table>
