	...
	<thead>
		<tr>
			<th data-options="field:'thId',hidden:true"></th>
				...
				<th data-options="field:'foodStd',required:'required',align:'center',width:180">伙食费标准</th>
				<th data-options="field:'foodStdTotal',required:'required',align:'center',width:180">总额标准</th>
				<c:if test="${empty detail}">
				<th data-options="field:'applySum',required:'required',align:'center',width:180,editor:{type:'numberbox',options:{onChange:addNum4,precision:2,groupSeparator:','}}">申请金额[元]</th>
				</c:if>
				<c:if test="${!empty detail}">
