...
<div class="window-tab" style="margin-left: 0px;padding-top: 10px">
	...
	<div id="outside_traffic_Id" style="height:30px;padding-top : 8px">
		...
		<a href="javascript:void(0)" onclick="removeitInternational()" hidden="hidden" id="outsideRemoveitId" style="float: right;"><img src="${base}/resource-modality/${themenurl}/button/scyh1.png" onMouseOver="mouseOver(this)" onMouseOut="mouseOut(this)"></a>
		<a style="float: right;">&nbsp;&nbsp;</a>
		<a href="javascript:void(0)" onclick="appendInternational()" hidden="hidden" id="outsideAppendId" style="float: right;"><img src="${base}/resource-modality/${themenurl}/button/tjyh1.png" onMouseOver="mouseOver(this)" onMouseOut="mouseOut(this)"></a>
	</div>
</div>
