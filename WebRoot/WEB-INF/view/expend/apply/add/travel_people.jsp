...
<div class="window-tab" style="margin-left: 0px;padding-top: 10px">
	...
	<table id="rpt" class="easyui-datagrid" style="width:680px;height:auto"
	data-options="
	singleSelect: true,
	toolbar: '#rph',
	...
	">
		<thead>
			<tr>
				...
				<th data-options="field:'travelDays',width:200,align:'center',editor:{type:'numberbox',options:{editable:false,onChange:changeTravel}}">出差天数</th>
				<th data-options="field:'hotelDays',width:200,align:'center',editor:{type:'numberbox',options:{onChange:changeHotel}}">住宿天数</th>
			</tr>
		</thead>
	</table>
	<c:if test="${empty detail}">
