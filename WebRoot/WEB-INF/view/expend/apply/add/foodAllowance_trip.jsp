...
<div class="window-tab" style="margin-left: 0px;padding-top: 10px;border-top: 1px solid rgba(217,227,231,1);">
	...
	<div id="foodtoolTrip" style="height:20px;padding-top : 8px">
		...
		<a style="float: right;color: #666666;font-size:12px;">小计金额：<span id="applyFoodAmountTrip"><fmt:formatNumber groupingUsed="true" value="${bean.foodAmount}" minFractionDigits="2" maxFractionDigits="2"/>[元]</span></a>
