...
<div class="window-tab" style="margin-left: 0px;padding-top: 10px">
	...
	<thead>
		<tr>
				...
				<c:if test="${empty detail}">
				<th data-options="field:'applySum',required:'required',align:'center',width:180,editor:{type:'numberbox',options:{onChange:addNum2,precision:2,groupSeparator:',',editable:false}}">申请金额（元）</th>
				</c:if>
				<c:if test="${!empty detail}">
