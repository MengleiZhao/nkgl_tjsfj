...
<body>
<div class="win-div">
<form id="purchase_cashier_form" method="post" data-options="novalidate:true" class="easyui-form" enctype="multipart/form-data">
			...
			<div class="win-left-top-div">
				<div class="easyui-accordion" data-options="" id="" style="width:662px;margin-left: 20px">
					...
					<div title="采购清单" data-options="iconCls:'icon-xxlb'" style="overflow:auto;margin-top: 10px;">
					  	...
					  	<%-- <jsp:include page="../../purchase_manage/purchase/check_mingxi.jsp" /> 	 --%>											
					</div>
					<!-- 第四个div -->
					...
					<%-- <div title="出纳受理" data-options="iconCls:'icon-xxlb',collapsed:false,collapsible:false"
						style="overflow:auto;margin-top: 10px;">
						<table class="ourtable" cellpadding="0" cellspacing="0" border="0">
							<tr class="trbody">
								...
								<td class="td2">
									<input style="width: 200px;" name="acceptTime" class="easyui-datebox" readonly="readonly" value="date"/>
								</td>
							</tr>
...
function check(result) {
	$('#purchase_cashier_form').form('submit', {
		onSubmit : function() {
		...
		url : base + '/cashier/purchaseCashierResult?result='+result,
		success : function(data) {
			if (flag) {
			...
			if (data.success) {
				...
				closeWindow();
				$('#purchase_cashier_form').form('clear');
