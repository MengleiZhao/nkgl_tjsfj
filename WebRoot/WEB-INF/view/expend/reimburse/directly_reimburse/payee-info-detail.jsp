...
<div class="window-tab" style="margin-left: 0px;padding-top: 10px">
		<table id="" class="easyui-datagrid" style="width:695px;height:auto"
		data-options="
		singleSelect: true,
		toolbar: '#payer_info_dir_detail_toolbar',
		...
		<div id="payer_info_dir_detail_toolbar" style="height:30px;padding-top : 8px">
