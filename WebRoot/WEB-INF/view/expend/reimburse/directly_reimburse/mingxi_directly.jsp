		...
		<tbody id="directly_0" >
			<tr>
				<td class="td1" style="width: 100px;">
					&nbsp;&nbsp;<span id="directlyFp_0">收据1</span>
					<input type="text" id="directlyfp_0" name="fileId" hidden="hidden">
					<input type="file" id="directlyImage_0" onchange="directlyUpImageFile(this)" hidden="hidden">
				</td>
					...
					success : function(data) {
			        	...
			        	if(y!=0){
							...
							.append(
				        		...
				        		$('#directlyimagetd_'+j).append('<img style="vertical-align:bottom;margin-left:0px; width: 100px;height: 73px" src="'+data+'" onclick="yl(this.src)"/><a style="color:red" href="#" id="sc_'+j+'" onclick="commdeleteImage(this)">    删除</a>');
				        	}
