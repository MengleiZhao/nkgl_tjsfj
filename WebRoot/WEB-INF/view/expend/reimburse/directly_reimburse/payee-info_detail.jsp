		...
		">
			<thead>
				<tr>
					...
					<th data-options="field:'bankAccount',align:'center',editor:{type:'textbox',options:{editable:true}}" width="25%">建行卡号</th>
					<!-- <th data-options="field:'bank',align:'center',editor:{type:'textbox',options:{editable:true}}" width="25%">开户银行</th> -->
					<th data-options="field:'payeeAmount',align:'center',editor:{type:'numberbox',options:{editable:true,precision:2}}" width="49.5%">转账金额</th>
				</tr>
			</thead>
		</table>
