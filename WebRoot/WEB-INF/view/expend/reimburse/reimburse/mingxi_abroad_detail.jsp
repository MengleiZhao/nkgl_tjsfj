	...
	<table class="window-table-readonly" cellspacing="0" cellpadding="0" style="">
			<tr>
				...
				<td class="window-table-td2" style="width:17%">
					<p id="p_hotelMoney">${receptionBean.costHotel}元</p>
				</td>
				<td>
				</td>
			</tr>
			...
			<tr>
				...
				<td class="td2" colspan="4" id="zfbimagetd_${st1.index}">
					...
					<img style="vertical-align:bottom;width: 100px; height: 73px;" src="${base}/attachment/download/${fp1.fileId}" onclick="yl(this.src)"/>
					</c:if>		
			</tr>
			<tr>
				<td class="td2" colspan="5" id="">
					<div style="width: auto; height:auto;margin-top:5px;margin-left:49px;">
						<p style="margin-bottom:10px;">
							...
							<input  class="easyui-numberbox" style="width:110px;height:25px" name="amount" id="amount_${st1.index}" value="${fp1.amount}"  onchange="addAmonut(this)" readonly="readonly"
							data-options="precision:2,icons: [{iconCls:'icon-yuan'}],groupSeparator:','"/>
							<span class="fp_span1">专项税额：</span>
							<input  name="tax" id="tax_${st1.index}" class="easyui-numberbox" style="width:110px;height:25px" value="${fp1.tax}" readonly="readonly"
							 data-options="precision:2,icons: [{iconCls:'icon-yuan'}],groupSeparator:','"/>
						</p>
						<p style="margin-bottom:10px;">
...
<form id="form2">		
	<table class="window-table-readonly" cellspacing="0" cellpadding="0" style="">
			<tr>
				...
				<td class="window-table-td1"><p>申请金额：</p></td>
				<td class="window-table-td2" style="width:17%">
					<p id="p_foodMoney">${receptionBean.costFood}元</p>
				</td>
				<td>
				</td>
			</tr>
		<c:forEach items="${fp2}" var="fp2" varStatus="st2">
			...
			<tr>
				...
				<td class="td2" colspan="4" id="zfbimagetd_${st2.index+a}">
					...
					<img style="vertical-align:bottom;width: 100px; height: 73px;" src="${base}/attachment/download/${fp2.fileId}" onclick="yl(this.src)"/>
					</c:if>		
				</td>	
			</tr>
...
<form id="form3">		
	<table class="window-table-readonly" cellspacing="0" cellpadding="0" style="">
			...
			<tbody id="short_${st3.index}" >
			<tr>
				<td class="td1">
					&nbsp;&nbsp;<span id="shortFp_${st3.index}">发票${st3.index+1}</span>
				...
				<td class="td2" colspan="4" id="zfbimagetd_${st3.index+a+b}">
					...
					<img style="vertical-align:bottom;width: 100px; height:73px;" src="${base}/attachment/download/${fp3.fileId}" onclick="yl(this.src)"/>
					</c:if>		
				</td>	
			</tr>
			...
			<tr>
				<td class="td2" colspan="5" >
					<div style="width: auto; height:auto;margin-top:5px;margin-left:49px;">
						<p style="margin-bottom:5px;">
							<span class="fp_span">票面金额：</span>
							<input  class="easyui-numberbox" style="width:110px;height:25px" name="amount"  id="amount_${st3.index+a+b}" onchange="addAmonut(this)" readonly="readonly"
							value="${fp3.amount}" data-options="precision:2,icons: [{iconCls:'icon-yuan'}],groupSeparator:','"/>
							<span class="fp_span1">专项税额：</span>
							<input  class="easyui-numberbox" style="width:110px;height:25px" name="tax" id="tax_${st3.index+a+b}" readonly="readonly"
							value="${fp3.tax}" data-options="precision:2,icons: [{iconCls:'icon-yuan'}],groupSeparator:','"/>
						</p>
						<p style="margin-bottom:5px;">
							<span class="fp_span">开票时间：</span>
	...
	<table class="window-table-readonly" cellspacing="0" cellpadding="0" style="">
			...
			<tr>
				...
				<td class="td2" colspan="4" id="zfbimagetd_${st4.index+a+b+c}">
					...
					<img style="vertical-align:bottom;width: 100px; height: 73px;" src="${base}/attachment/download/${fp4.fileId}" onclick="yl(this.src)"/>
					</c:if>		
				</td>	
			</tr>
			...
			<tr>
				<td class="td2" colspan="5" >
					<div style="width: auto; height:auto;margin-top:5px;margin-left:49px;">
						<p style="margin-bottom:5px;">
							<span class="fp_span">票面金额：</span>
							<input  class="easyui-numberbox" style="width:110px;height:25px" name="amount" id="amount_${st4.index+a+b+c}"  class="a" onchange="addAmonut(this)" readonly="readonly"
							value="${fp4.amount}" data-options="precision:2,icons: [{iconCls:'icon-yuan'}],groupSeparator:','"/>
							<span class="fp_span1">专项税额：</span>
							<input  class="easyui-numberbox" style="width:110px;height:25px" name="tax" id="tax_${st4.index+a+b+c}" readonly="readonly"
							value="${fp4.tax}" data-options="precision:2,icons: [{iconCls:'icon-yuan'}],groupSeparator:','"/>
						</p>
						<p style="margin-bottom:5px;">
							<span class="fp_span">开票时间：</span>
							<input  class="easyui-datebox" style="width:110px;height:25px" name="time" id="time_${st4.index+a+b+c}"  readonly="readonly"
							value="${fp4.time}" />
						</p>
						<p style="margin-bottom:5px;">
							<span class="fp_span">备注：</span>
		...
		<c:forEach items="${fp5}" var="fp5" varStatus="st5">		
			...
			<tr>
				...
				<td class="td2" colspan="4" id="zfbimagetd_${st5.index+a+b+c+d}">
					...
					<img style="vertical-align:bottom;width: 100px; height: 73px;" src="${base}/attachment/download/${fp5.fileId}" onclick="yl(this.src)"/>
					</c:if>		
				</td>	
			</tr>
...
<form id="form5">
	<table class="window-table-readonly" cellspacing="0" cellpadding="0" style="margin-bottom:0px;">
		...
		<c:forEach items="${fp6}" var="fp6" varStatus="st6">		
			<tbody id="other_${st6.index}" >
			<tr>
				<td class="td1">
					&nbsp;&nbsp;发票${st6.index+1}
					<input type="text" id="fp_${st6.index+a+b+c+d+f}" name="fileId" hidden="hidden">
					<input type="file" id="image_${st6.index+a+b+c+d+f}" onchange="upImageFile(this)" hidden="hidden">
				</td>
				<td class="td2" colspan="4" id="zfbimagetd_${st6.index+a+b+c+d+f}">
					<c:if test="${fp6.fileId!=null&&!empty fp6.fileId}">
					<img style="vertical-align:bottom;width:100px; height: 73px;" src="${base}/attachment/download/${fp6.fileId}" onclick="yl(this.src)"/>
					</c:if>		
				</td>	
			</tr>
			...
			<tr>
				<td class="td2" colspan="5" >
					<div style="width: auto; height:auto;margin-top:5px;margin-left:49px;">
						<p style="margin-bottom:5px;">
							<span class="fp_span">票面金额：</span>
							<input  class="easyui-numberbox" style="width:110px;height:25px" name="amount" id="amount_${st6.index+a+b+c+d+f}"  class="a" onchange="addAmonut(this)" readonly="readonly"
							value="${fp6.amount}" data-options="precision:2,icons: [{iconCls:'icon-yuan'}],groupSeparator:','"/>
							<span class="fp_span1">专项税额：</span>
							<input  class="easyui-numberbox" style="width:110px;height:25px" name="tax" id="tax_${st6.index+a+b+c+d+f}" readonly="readonly"
							value="${fp6.tax}" data-options="precision:2,icons: [{iconCls:'icon-yuan'}],groupSeparator:','"/>
						</p>
						<p style="margin-bottom:5px;">
							<span class="fp_span">开票时间：</span>
							<input  class="easyui-datebox" style="width:110px;height:25px" name="time" id="time_${st6.index+a+b+c+d+f}"  readonly="readonly"
							value="${fp6.time}" />
						</p>
						<p style="margin-bottom:5px;">
							<span class="fp_span">备注：</span>
							<input  class="easyui-textbox" style="width:328px;height:25px" name="remark" id="remark_${st6.index+a+b+c+d+f}"  readonly="readonly"
							value="${fp6.remark}" />
						</p>
						<p style="margin-bottom:5px;">
							<span style="width: 85px;display: inline-block;">核验结果：</span>
