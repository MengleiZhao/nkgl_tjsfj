		...
		">
			<thead>
				<tr>
					...
					<th data-options="field:'fCardNo',align:'center',editor:{type:'textbox',options:{editable:false}}" width="25%">银行账户</th>
					<th data-options="field:'fBankName',align:'center',editor:{type:'textbox',options:{editable:false}}" width="25%">开户银行</th>
					<th data-options="field:'payeeAmount',align:'center',editor:{type:'numberbox',options:{editable:false,precision:2}}" width="25%">转账金额</th>
				</tr>
			</thead>
		</table>
