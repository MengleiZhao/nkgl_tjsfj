			...
			<tbody id="hotel_${i.index}" >
				<tr>
					<td class="td1" style="width: 100px;">
						...
						<input type="file" id="image_${i.index}" onchange="upImageFilehotel(this)" hidden="hidden">
					</td>
...
function countTravel(obj){
	...
	function appendhotel(obj) {
		...
		'<input type="file" id="image_'+a+'" onchange="upImageFilehotel(this)" hidden="hidden"></td>'+
