...
<div class="window-tab" style="margin-left: 0px;padding-top: 10px;border-top: 1px solid rgba(217,227,231,1);">
	...
	<div id="hoteltoolTripReim" style="height:20px;padding-top : 8px">
		...
		<a style="float: left;color: #666666;font-size:12px;">报销金额：<span id="hotelAmountsTripReim"><fmt:formatNumber groupingUsed="true" value="${applyBean.hotelAmount}" minFractionDigits="2" maxFractionDigits="2"/>[元]</span></a>
		</c:if>
