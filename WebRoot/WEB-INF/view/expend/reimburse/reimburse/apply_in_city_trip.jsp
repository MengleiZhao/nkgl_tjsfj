...
<div class="window-tab" style="margin-left: 0px;padding-top: 10px;">
	...
	<table id="in_city_trip_reim_tab_id" class="easyui-datagrid" style="width:707px;height:auto"
	data-options="
	singleSelect: true,
	toolbar: '#in_city_trip_reim_id',
	...
	onClickRow:onClickRowInCityReim,
	method: 'post',
	striped : true,
	nowrap : false,
	rownumbers:true,
	...
	">
		<thead>
			<tr>
				...
				<th data-options="field:'fAdjacentDay',align:'center',width:180,editor:{type:'numberbox',options:{editable:true,onChange:adjacentDayCountReim}}" >相邻区补贴天数</th>
				<th data-options="field:'fDistanceDay',align:'center',width:180,editor:{type:'numberbox',options:{editable:true,onChange:distanceDayCountReim}}" >相隔区补贴天数</th>
				<th data-options="field:'fApplyAmount',width:160,align:'center',editor:{type:'numberbox',options:{editable:false,precision:2,onChange:fApplyAmountCityReim}}">报销金额</th>
			</tr>
		</thead>
	</table>
	<div id="in_city_trip_reim_id" style="height:30px;padding-top : 8px">
		...
		<a style="float: left;color: #666666;font-size:12px;">报销金额：<span id="applyInCityAmountTripReim"><fmt:formatNumber groupingUsed="true" value="${applyBean.cityAmount}" minFractionDigits="2" maxFractionDigits="2"/>[元]</span></a>
		</c:if>
	...
	function fApplyAmountCityReim(newVal,oldVal){
		...
		var index=$('#in_city_trip_reim_tab_id').datagrid('getRowIndex',$('#in_city_trip_reim_tab_id').datagrid('getSelected'));
	     ...
	     for(var i=0;i<rows.length;i++){
			...
			$("#p_amount").html(listToFixed((parseFloat(foodAmount)+parseFloat(hotelAmount)+parseFloat(num1)).toFixed(2))+"元");
