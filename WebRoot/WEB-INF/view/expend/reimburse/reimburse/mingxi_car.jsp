...
<div class="window-tab" style="margin-left: 0px;padding-top: 10px">
	...
	<table id="reimburse_cart" class="easyui-datagrid" style="width:695px;height:auto"
	data-options="
	singleSelect: true,
	...
	">
		<thead>
			<tr>
				...
				<th data-options="field:'fExpenseName',width:137,align:'center',editor:{type: 'combobox',options: {valueField:'id',textField:'text',data:[
	                	{id:'燃料费',text:'燃料费'},
	                	{id:'维修费',text:'维修费'},
	                	{id:'过路过桥费',text:'过路过桥费'},
	                	{id:'保险费',text:'保险费'},
				...
				<th data-options="field:'fUseAmount',width:100,align:'center',editor:{type:'numberbox',options:{onChange:addCarAmount,iconCls:'icon-yuan',precision:2,groupSeparator:','}}">报销金额</th>
...
//接待人员表格添加删除，保存方法
	...
	function removeitCar() {
		...
		$('#rOutsideTrafficAmount').html(fomatMoney(num,2)+" [元]");
	...
	function addCarAmount(newVal,oldVal){
		...
		$("#rOutsideTrafficAmount").html(fomatMoney(num1)+"[元]");
		$("#p_amount").html(fomatMoney(num1)+"[元]");
		$("#reimburseAmount").val(fomatMoney(num1));
