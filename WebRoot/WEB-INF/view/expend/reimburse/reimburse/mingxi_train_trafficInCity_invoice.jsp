		...
		<tbody id="incity_0" >
			<tr>
				<td class="td1" style="width: 100px;">
					...
					<input type="file" id="incityimage_0" accept="image/jpeg,image/jpg,image/png" onchange="upImageFile1(this)" hidden="hidden">
				</td>
...
function appendIncity(obj) {
	...
	'<input type="file" id="incityimage_'+a+'" accept="image/jpeg,image/jpg,image/png" onchange="upImageFile1(this)" hidden="hidden"></td>'+
					...
					success : function(data) {
			        	...
			        	if(y!=0){
							...
							.append(
				        		...
				        		$('#incityimagetd_'+j).append('<img style="vertical-align:bottom;margin-left:0px; width: 100px;height: 73px" src="'+data+'" onclick="yl(this.src)"/><a style="color:red" href="#" id="sc_'+j+'" onclick="deleteImageIncity(this)">    删除</a>');
				        	}
