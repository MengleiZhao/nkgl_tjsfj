		...
		<tbody id="fete_0" >
			<tr>
				<td class="td1" style="width: 100px;">
					&nbsp;&nbsp;<span id="feteFp_0">发票1</span>
					<input type="text" id="fetefp_0" name="fileId" hidden="hidden">
					<input type="file" id="feteImage_0" accept="image/jpeg,image/jpg,image/png" onchange="upImageFilefete(this)" hidden="hidden">
				</td>
				<td class="td2" colspan="3" id="feteZfbimagetd_0" style="width: 150px;">
					<a onclick="clickUpFilefete(this)" id="feteClick_0" style="font-weight: bold;" href="#">
				...
				<td class="td2" colspan="3" id="">
					<div style="width: auto; height:auto; height:auto;margin-top:5px;margin-left:49px;width: 300px;">
						<p style="margin-bottom:10px;">
							<span class="fetefp_span" >金额(元)：</span>
							<input class="input_amonut1 a easyui-numberbox" name="amount" id="feteAmount_0" onchange="addAmonut(this)"data-options="precision:2"/>
						</p>
						<p style="margin-bottom:5px;" >
							<span class="fetefp_span">备注：</span>
							<input  class="input_amonut1 easyui-textbox" name="remark" id="feteRemark_0" value="" />
						</p>
					</div>
				</td>
			</tr>
...
function countDays(obj){
	...
	if (d > 0) {
		var amount =parseFloat($('#feteAmount_' + i).val());
		if(!isNaN(amount)){
...
function countTravel(obj){
	...
	var i=id.substring(j+1,id.length);
	var num =0;
	var num1 =parseFloat($('#feteAmount_' + i).val());
	...
	function appendfete(obj) {
		...
		'<input type="file" id="feteImage_'+a+'" accept="image/jpeg,image/jpg,image/png" onchange="upImageFilefete(this)" hidden="hidden"></td>'+
		'<td class="td2" colspan="3" id="feteZfbimagetd_'+a+'" style="width: 150px;">'+
		'<a onclick="clickUpFilefete(this)" id="feteClick_'+a+'" style="font-weight: bold;" href="#">'+
		'<img style="vertical-align:bottom;margin-left:30px" src="${base}/resource-modality/${themenurl}/button/shangchuan1.png" onMouseOver="mouseOver(this)" onMouseOut="mouseOut(this)">'+
		'</a></td>'+
		'<td class="td2" colspan="3" id="">'+
		'<div style="width: auto; height:auto; height:auto;margin-top:5px;margin-left:49px;width: 300px;">'+
		'<p style="margin-bottom:10px;">'+
		'<span class="fetefp_span" >金额(元)：</span>'+
		'<input class="input_amonut1 a easyui-numberbox" name="amount" id="feteAmount_'+a+'" onchange="addAmonut(this)"data-options="precision:2"/>'+
		'</p>'+
		'<p style="margin-bottom:5px;" >'+
		'<span class="fetefp_span">备注：</span>'+
		'<input  class="input_amonut1 easyui-textbox" name="remark" id="feteRemark_'+a+'" value="" />'+
		'</p></div>'+
		'</td>'+
						...
						success : function(data) {
				        	...
				        	if(y!=0){
								...
								.append(
					        		...
					        		$('#feteZfbimagetd_'+j).append('<img style="vertical-align:bottom;margin-left:0px; width: 100px;height: 73px" src="'+data+'" onclick="yl(this.src)"/><a style="color:red" href="#" id="sc_'+j+'" onclick="deleteImagefete(this)">    删除</a>');
					        	}
		...
		var id =obj.id;
	     ...
	     var y=num.substring(x+1,num.length);
	   	  if(y!=0){
	   		$('#feteZfbimagetd_' + j)
			.append(
					'<a onclick="clickUpFilefete(this)" id="feteClick_'
							+ j
      		...
      		$('#feteZfbimagetd_'+j).append('<a onclick="clickUpFilefete(this)" id="feteClick_'+j+'" style="font-weight: bold;" href="#">'+
