		...
		<tbody id="other_0" >
			<tr>
				<td class="td1" style="width: 100px;">
					...
					<input type="text" id="otherfp_0" name="fileId" hidden="hidden">
					<input type="file" id="otherImage_0" accept="image/jpeg,image/jpg,image/png" onchange="upImageFileother(this)" hidden="hidden">
				</td>
				<td class="td2" colspan="3" id="otherZfbimagetd_0" style="width: 150px;">
					<a onclick="clickUpFileother(this)" id="otherClick_0" style="font-weight: bold;" href="#">
				...
				<td class="td2" colspan="3" id="">
					<div style="width: auto; height:auto; height:auto;margin-top:5px;margin-left:49px;width: 300px;">
						<p style="margin-bottom:10px;">
							...
							<input class="input_amonut1 a easyui-numberbox" name="amount" id="otherAmount_0" onchange="addAmonut(this)"data-options="precision:2"/>
						</p>
						<p style="margin-bottom:5px;" >
							<span class="otherfp_span">备注：</span>
							<input  class="input_amonut1 easyui-textbox" name="remark" id="otherRemark_0" value="" />
						</p>
					</div>
				</td>
			</tr>
...
function countTravel(obj){
	...
	function appendother(obj) {
		...
		'<td class="td2" colspan="3" id="otherZfbimagetd_'+a+'" style="width: 150px;">'+
		...
		'<p style="margin-bottom:10px;">'+
		'<span class="otherfp_span" >金额(元)：</span>'+
		'<input class="input_amonut1 a easyui-numberbox" name="amount" id="otherAmount_'+a+'" onchange="addAmonut(this)"data-options="precision:2"/>'+
		'</p>'+
		'<p style="margin-bottom:5px;" >'+
		'<span class="otherfp_span">备注：</span>'+
						...
						success : function(data) {
				        	...
				        	if(y!=0){
								...
								.append(
					        		...
					        		$('#otherZfbimagetd_'+j).append('<img style="vertical-align:bottom;margin-left:0px; width: 100px;height: 73px" src="'+data+'" onclick="yl(this.src)"/><a style="color:red" href="#" id="sc_'+j+'" onclick="deleteImageother(this)">    删除</a>');
					        	}
		...
		var id =obj.id;
	     ...
	     var y=num.substring(x+1,num.length);
			...
			.append(
      		...
      		$('#otherZfbimagetd_'+j).append('<a onclick="clickUpFileother(this)" id="otherClick_'+j+'" style="font-weight: bold;" href="#">'+
