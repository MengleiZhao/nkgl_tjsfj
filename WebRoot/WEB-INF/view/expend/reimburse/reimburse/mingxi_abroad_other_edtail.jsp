			...
			<tbody id="other_${i.index}" >
				<tr>
					<td class="td1" style="width: 100px;">
						...
						<input type="file" id="image_${i.index}" onchange="upImageFileother(this)" hidden="hidden">
					</td>
...
function countTravel(obj){
	...
	function appendother(obj) {
		...
		'<input type="file" id="image_'+a+'" onchange="upImageFileother(this)" hidden="hidden"></td>'+
