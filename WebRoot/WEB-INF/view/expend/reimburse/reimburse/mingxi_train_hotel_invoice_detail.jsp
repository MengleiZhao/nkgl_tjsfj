			...
			<tbody id="hotel_${i.index}" >
				<tr>
					<td class="td1" style="width: 100px;">
						...
						<input type="file" id="hotelimage_${i.index}" onchange="upImageFileHotel(this)" hidden="hidden">
					</td>
...
function appendHotel(obj) {
	...
	'<input type="file" id="hotelimage_'+a+'" onchange="upImageFileHotel(this)" hidden="hidden"></td>'+
