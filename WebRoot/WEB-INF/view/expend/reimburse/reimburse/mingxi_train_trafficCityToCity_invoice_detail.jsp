			...
			<tbody id="outside_${i.index}" >
				<tr>
					<td class="td1" style="width: 100px;">
						...
						<input type="file" id="image_${i.index}" onchange="upImageFileOutside(this)" hidden="hidden">
					</td>
...
function countTravel(obj){
	...
	function appendOutside(obj) {
		...
		'<input type="file" id="image_'+a+'" onchange="upImageFileOutside(this)" hidden="hidden"></td>'+
