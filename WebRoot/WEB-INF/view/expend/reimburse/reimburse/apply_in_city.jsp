...
<div class="window-tab" style="margin-left: 0px;padding-top: 10px;border-top: 1px solid rgba(217,227,231,1);">
	...
	url: '${base}/reimburse/applyInCityPage?rId=${bean.rId}&travelType=GWCC',
	</c:if>
	<c:if test="${empty applyBean.gId}">
	url: '',
	</c:if>
	...
	">
		<thead>
			<tr>
				...
				<th data-options="field:'fApplyAmount',width:227,align:'center',editor:{type:'numberbox',options:{editable:false,precision:2}}">报销金额</th>
			</tr>
		</thead>
	</table>
	<c:if test="${!empty operation}">
