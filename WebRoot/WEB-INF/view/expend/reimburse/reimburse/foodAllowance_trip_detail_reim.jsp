...
<div class="window-tab" style="margin-left: 0px;padding-top: 10px;border-top: 1px solid rgba(217,227,231,1);">
	...
	<table id="foodtabTripReimDetail" class="easyui-datagrid" style="width:707px;height:auto"
	data-options="
	singleSelect: true,
	toolbar: '#foodtoolTripDetailReim',
	...
	">
		<thead>
			<tr>
				...
				<th data-options="field:'fname',align:'center',width:160,editor:{type:'textbox',readonly:false}" >姓名</th>
				<th data-options="field:'fDays',align:'center',width:260,editor:{type:'numberbox',options:{editable:false}}" >补贴天数</th>
				<th data-options="field:'fApplyAmount',align:'center',width:255,editor:{type:'numberbox',options:{editable:false,precision:2}}" >报销金额</th>
				<th data-options="field:'fnameId',hidden:true,editor:{type:'textbox',options:{editable:false}}"></th>
			</tr>
		</thead>
	</table>
	<div id="foodtoolTripDetailReim" style="height:20px;padding-top : 8px">
		...
		<a style="float: left;">&nbsp;&nbsp;</a>
		<a style="float: left;color: #666666;font-size:12px;">报销金额：<span id=""><fmt:formatNumber groupingUsed="true" value="${bean.foodAmount}" minFractionDigits="2" maxFractionDigits="2"/>[元]</span></a>
	</div>
</div>
