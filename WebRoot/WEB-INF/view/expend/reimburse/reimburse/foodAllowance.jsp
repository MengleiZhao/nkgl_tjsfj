...
<div class="window-tab" style="margin-left: 0px;padding-top: 10px;border-top: 1px solid rgba(217,227,231,1);">
	...
	url: '${base}/reimburse/foodJson?rId=${bean.rId}&travelType=GWCC',
	</c:if>
	...
	">
		<thead>
			<tr>
				...
				<th data-options="field:'fDays',width:220,align:'center',editor:{type:'numberbox',options:{editable:true}}" >补贴天数</th>
