...
function countTravel(obj){
	...
	function appendmix(obj) {
		...
		'<input type="file" id="image_'+a+'" onchange="upImageFilemix(this)" hidden="hidden"></td>'+
						...
						success : function(data) {
				        	...
				        	if(y!=0){
								...
								.append(
					        		...
					        		$('#zfbimagetd_'+j).append('<img style="vertical-align:bottom;margin-left:0px; width: 100px;height: 73px" src="'+data+'" onclick="yl(this.src)"/><a style="color:red" href="#" id="mixsc_'+j+'" onclick="deleteImagemix(this)">    删除</a>');
					        	}
		...
		var id =obj.id;
	     ...
	     var y=num.substring(x+1,num.length);
			...
			.append(
      		...
      		$('#zfbimagetd_'+j).append('<a onclick="clickUpFilemix(this)" id="clickmix_'+j+'" style="font-weight: bold;" href="#">'+
