...
<table class="window-table" cellspacing="0" cellpadding="0" style="margin-top: 0px;">
	...
	<tr class="trbody">
		...
		<td class="td2" style="width: 281px;">
			...
			data-options="onHidePanel:onHidepanel1" value="${reimbMeetingBean.dateStart}" readonly="readonly" required="required" editable="false"/>
		</td>
		...
		<td class="td2">
			...
			data-options="onHidePanel:onHidepanel" value="${reimbMeetingBean.dateEnd}" readonly="readonly" required="required" editable="false"/>
		</td>
	</tr>
	<tr class="trbody">
		...
		<td class="td2" style="width: 200px;">
			<input id="meetingType" class="easyui-combobox" style="width: 200px; height: 30px;" readonly="readonly" name="meetingType" value="${reimbMeetingBean.meetingType}"
	...
	<tr class="trbody">
		...
		<td colspan="3">
			...
			value="${reimbMeetingBean.meetingPlace}" readonly="readonly" required="required" data-options="prompt: '填写时地点精确到会议室房间号' ,validType:'length[1,50]'"/>
		</td>
	</tr>
	<tr class="trbody">
		...
		<td colspan="3">
			...
			value="${reimbMeetingBean.attendPeople}" readonly="readonly" required="required" data-options="validType:'length[1,100]'"/>
		</td>
	</tr>
	<tr class="trbody">
		...
		<td class="td2"><input class="easyui-numberbox" style="width: 200px; height: 30px;" name="attendNum" id="attendNum"
			value="${reimbMeetingBean.attendNum}" readonly="readonly" required="required" data-options="validType:'length[1,3]'"/>
		</td>
		...
		<td class="td2">
			...
			value="${reimbMeetingBean.staffNum}" readonly="readonly" required="required" data-options="validType:'length[1,3]'"/> 
		</td>
	</tr>
	...
	<tr class="trbody">
		...
		<td class="td2">
			<div id="fWAHotelId">
				...
				&nbsp;&nbsp;
				<input type="radio" value="0" onclick="onclickHotelReim()" name="fWAHotel" disabled="disabled" <c:if test="${reimbMeetingBean.fWAHotel=='0' || empty reimbMeetingBean.fWAHotel}">checked="checked" </c:if> style="vertical-align: text-top;"/>&nbsp;&nbsp;否
			</div>
		</td>
		...
		<td class="td2">
			<div id="fWAFoodId">
				...
				&nbsp;&nbsp;
				<input type="radio" value="0" onclick="onclickFoodReim()" name="fWAFood" disabled="disabled" <c:if test="${reimbMeetingBean.fWAFood=='0' || empty reimbMeetingBean.fWAFood}">checked="checked" </c:if> style="vertical-align: text-top;"/>&nbsp;&nbsp;否
			</div>
		</td>
	</tr>
	<tr class="trbody">
...
function onclickHotelReim(){
	...
	onLoadSuccessMeetingReim();
}
function onclickFoodReim(){
	acceptMeetingReim();
	var rows = $('#reimb-meeting-mingxi').datagrid('getRows');
	for (var i = 0; i < rows.length; i++) {
