		...
		">
			<thead>
				<tr>
					...
					<!-- <th data-options="field:'payeeName',align:'center',editor:{type:'textbox',options:{required:true}}" width="20%">收款人</th> -->
...
function appendinfo() {
	var rowNum = $('#payer_info_tab').datagrid('getRows').length;
	if(rowNum<1){
		if (endEditinginfo()) {
