			...
			<tbody id="hotel_${i.index}" >
				<tr>
					<td class="td1" style="width: 100px;">
						...
						<input type="file" id="image_${i.index}" accept="image/jpeg,image/jpg,image/png" onchange="upImageFilehotel(this)" hidden="hidden">
					</td>
...
function countTravel(obj){
	...
	function appendhotel(obj) {
		...
		'<input type="file" id="image_'+a+'" accept="image/jpeg,image/jpg,image/png" onchange="upImageFilehotel(this)" hidden="hidden"></td>'+
						...
						success : function(data) {
				        	...
				        	if(y!=0){
								...
								.append(
					        		...
					        		$('#zfbimagetd_'+j).append('<img style="vertical-align:bottom;margin-left:0px; width: 100px;height: 73px" src="'+data+'" onclick="yl(this.src)"/><a style="color:red" href="#" id="hotelsc_'+j+'" onclick="deleteImagehotel(this)">    删除</a>');
					        	}
		...
		var id =obj.id;
	     ...
	     var y=num.substring(x+1,num.length);
			...
			.append(
      		...
      		$('#zfbimagetd_'+j).append('<a onclick="clickUpFilehotel(this)" id="clickhotel_'+j+'" style="font-weight: bold;" href="#">'+
