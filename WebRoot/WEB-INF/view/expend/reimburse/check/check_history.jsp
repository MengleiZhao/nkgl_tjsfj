...
<div class="window-tab" style="margin-left: 0px;margin-top: 10px">
	...
	<thead>
		<tr>
			...
			<th data-options="field:'fcheckTime',required:'required',align:'center',width:'25%',formatter: ChangeDateFormat1">审批时间</th>
			<th data-options="field:'fcheckRemake',required:'required',align:'center',width:'27%',formatter:formatCellTooltip">审批意见</th>
