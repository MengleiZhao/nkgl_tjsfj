...
data-options="
url: '${base}/checkHistory/history?id=${bean.drId}&type=directly',
method: 'post',
striped : true,
nowrap : true,
rownumbers:true,
...
<thead>
	<tr>
		...
		<th data-options="field:'fcheckRemake',required:'required',align:'center',width:185,formatter:formatCellTooltip">审批内容</th>
	</tr>
</thead>
