...
<body>
<div class="win-div">
<form id="ReceLowAddEditForm" action="${base}/Rece/save?fAssType=ZCLX-01" method="post" data-options="novalidate:true" class="easyui-form" enctype="multipart/form-data">
							...
							<div title="领用单详情" data-options="iconCls:'icon-xxlb',collapsed:false,collapsible:false" style="overflow:auto;margin-top:10px;">
								<table class="ourtable" cellpadding="0" cellspacing="0">
									...
									<tr class="trbody">
										...
										<td class="td2">
											<%-- <c:if test="${openType=='add'||openType=='edit'}"><a onclick="fReceCode()">	</c:if> --%>		
												<input id="R_fReceDept"  class="easyui-textbox" readonly="readonly"  name="fReceDept" data-options="prompt:'点击选择',validType:'length[1,20]'" style="width: 200px" value="${bean.fReceDept}"/>					
										</td>
										<td class="td4">&nbsp;</td>
										<td class="td1">&nbsp;&nbsp;领用人</td>
										<td class="td2">
									...
									<c:if test="${bean.fFlowStauts_R =='9'}">
									<tr class="trbody">
										<td class="td1"><span class="style1">*</span>领用日期</td>
										<td class="td2">
											<input class="easyui-datebox" class="dfinput" readonly="readonly" id="R_fReceTime" name="fReceTime"  data-options="validType:'length[1,20]'" style="width: 200px" value="${bean.fReceTime}"/>
										</td>
										<td class="td4">&nbsp;</td>
									...
									<tr style="height: 70px;">
										...
										<td  colspan="4">
											<%-- <input class="easyui-textbox" data-options="multiline:true,validType:'length[0,200]'"
											 id="R_fOtherRemark" name="fOtherRemark" style="width: 555px;height:70px" value="${bean.fOtherRemark}"> --%>  
											<!-- <input type="text" id="S_fFlowStauts" name="fFlowStauts" hidden="hidden" value="0"/> -->
