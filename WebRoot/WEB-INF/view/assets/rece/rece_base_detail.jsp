	...
	<div class="window-div">
		<div class="window-left-div" style="width:765px;height: 491px;border: 1px solid #D9E3E7;margin-top: 20px;">
				...
				<div class="easyui-accordion" style="margin-left: 20px;margin-right: 20px;">
					...
					<c:if test="${!empty configList }">
						<div title="配置明细" data-options="collapsed:false,collapsible:false" style="overflow:auto">
				        	<%@ include file="approval/rece_base_approval_config_plan.jsp" %>
						</div>
					</c:if>
			...
			<div class="window-left-bottom-div" style="margin-top: 55px;">
				<c:if test="${detailType=='agreeOrUnagree'}">
					<a href="javascript:void(0)" onclick="openCheckWin('审批意见','1')">
						<img src="${base}/resource-modality/${themenurl}/button/ty1.png" onMouseOver="mouseOver(this)" onMouseOut="mouseOut(this)">
					</a>&nbsp;&nbsp;&nbsp;
					<a href="javascript:void(0)" onclick="openCheckWin('审批意见','0')">
						<img src="${base}/resource-modality/${themenurl}/button/bty1.png" onMouseOver="mouseOver(this)" onMouseOut="mouseOut(this)">
					</a>&nbsp;&nbsp;&nbsp;
				</c:if>
				<c:if test="${detailType=='accept'}">
					<a href="javascript:void(0)" onclick="rece_Accept('${bean.fId_R}')">
...
function rece_Accept(id) {
	if(confirm('是否已将该信息录入财政资产系统?')){
		$.ajax({
			url:base+'/Rece/accept',
			type:'POST',
			data:{'id':id},
			success : function(data) {
				...
				if (data.success) {
					...
					$("#rece_fixed_accept_dg").datagrid('reload');
					closeWindow();
				} else {
...
function check(stauts){
	...
	$('#ReceLowAddEditForm').form('submit', {
			...
			url:'${base}/Rece/approvelConfig/'+stauts,
