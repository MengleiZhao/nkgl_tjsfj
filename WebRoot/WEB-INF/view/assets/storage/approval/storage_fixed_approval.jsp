					...
					<div class="easyui-accordion" style="width:662px;margin-left: 15px;">
						<div title="资产登记表" data-options="collapsed:false,collapsible:false" style="overflow:auto;margin-top:10px;">
							...
							<tr class="trbody">
								...
								<td class="td2">
									<input class="easyui-combobox" id="storage_fixed_fAssClass" name="fAssClass" readonly="readonly" data-options="url:'${base}/lookup/lookupsJson?parentCode=GDZCLB&selected=${bean.fAssClass}',method:'post',valueField:'code',textField:'text',editable:false,onSelect:onselectfAssClass" style="width: 200px;">
								</td>
								<td class="td4">&nbsp;</td>
