...
<body>
<form id="saveRegister" action="${base}/Storage/saveRegister" method="post" data-options="novalidate:true" class="easyui-form" enctype="multipart/form-data">
			...
			<div class="win-left-top-div">
				...
				<div class="easyui-accordion" style="width:662px;margin-left: 15px;">
					...
					<div title="资产详情表" data-options="iconCls:'icon-xxlb',collapsed:false,collapsible:false" style="overflow:auto;margin-top:10px;">
						<%@ include file="storage_fixed_add_plan_register.jsp" %>
					</div>
				</div>			
			</div>
