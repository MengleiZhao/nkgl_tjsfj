							...
							<div title="调拨单详情" data-options="iconCls:'icon-xxlb',collapsed:false,collapsible:false" style="overflow:auto;margin-top:10px;">
								<table class="ourtable" cellpadding="0" cellspacing="0">
									...
									<tr class="trbody">
										...
										<td class="td2">
											<a onclick="inDepart()"><input class="easyui-textbox" required="required" class="dfinput"  id="A_fInDept" name="fInDept"  data-options="prompt:'点击选择',validType:'length[1,25]'" style="width: 200px" 
											value="${bean.fInDept }"/></a>
										</td>
										<td class="td4">&nbsp;</td>
										<td class="td1"><span class="style1">*</span>&nbsp;调出部门</td>
										<td class="td2">
											<input class="easyui-textbox" required="required" class="dfinput"  readonly="readonly" id="A_fOutDept" name="fOutDept"  data-options="validType:'length[1,20]'" style="width: 200px" value="${bean.fOutDept}"/>
										</td>
									</tr>
									<tr class="trbody">
										<td class="td1"><span class="style1">*</span>&nbsp;调入日期</td>
										<td class="td2">
											<input class="easyui-datebox" required="required" class="dfinput"  id="A_fInTime" name="fInTime" editable="false" data-options="prompt:'',validType:'length[1,25]'" style="width: 200px" 
											value="${bean.fInTime }"/>
										</td>
										<td class="td4">&nbsp;</td>
										<td class="td1"><span class="style1">*</span>&nbsp;调出日期</td>
										<td class="td2">
											<input class="easyui-datebox" required="required" class="dfinput"  id="A_fOutTime" name="fOutTime" editable="false" data-options="validType:'length[1,20]'" style="width: 200px" 
											value="${bean.fOutTime}"/>
										</td>
									</tr>
									<tr class="trbody">
										...
										<td class="td2">
											<input class="easyui-textbox" required="required" class="dfinput"  id="A_fInUser" name="fInUser"  data-options="prompt:'',validType:'length[1,25]'" style="width: 200px" 
											value="${bean.fInUser }"/>
										</td>
										<td class="td4">&nbsp;</td>
										<td class="td1"><span class="style1">*</span>&nbsp;调出经办人</td>
										<td class="td2">
											<input class="easyui-textbox" required="required" class="dfinput"  readonly="readonly" id="A_fOutUser" name="fOutUser"  data-options="validType:'length[1,20]'" style="width: 200px" value="${bean.fOutUser}"/>
										</td>
									</tr>
									<tr class="trbody">
										<td class="td1"><span class="style1">*</span>&nbsp;合计数量</td>
										<td class="td2">
											<input class="easyui-numberbox" class="dfinput" required="required" id="A_fSumNumber" name="fSumNumber"  data-options="prompt:'',validType:'length[1,25]',precision:0" style="width: 200px" 
											value="${bean.fSumNumber }"/>
										</td>
										<td class="td4">&nbsp;</td>
										<td class="td1"><span class="style1">*</span>&nbsp;合计总值</td>
										<td class="td2">
											<input class="easyui-numberbox" class="dfinput" required="required" id="A_fSumAmount" name="fSumAmount" data-options="icons: [{iconCls:'icon-yuan'}],validType:'length[1,20]',precision:2" style="width: 200px" 
									...
									<tr style="height: 70px;">
										...
										<td  colspan="4">
											<%-- <input class="easyui-textbox" data-options="validType:'length[1,200]',multiline:true" required="required"
											 id="A_fAllocaRemark" name="fAllocaRemark" style="width: 555px;height:70px" value="${bean.fAllocaRemark}"> --%>  
