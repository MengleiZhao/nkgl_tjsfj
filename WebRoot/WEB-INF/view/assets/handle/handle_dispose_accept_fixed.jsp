...
<form id="handleDisposeAcceptForm" method="post" data-options="novalidate:true" class="easyui-form" enctype="multipart/form-data">
<div class="window-div">
		<div class="window-left-div" data-options="region:'west',split:true" style="width:745px;height: 491px;border: 1px solid #D9E3E7;margin-top: 20px;">
				...
				<div class="easyui-accordion" style="width:700px;margin-left: 20px;">
					<div  title="固定资产处置签报表" id="cgxxdiv" data-options="collapsed:false,collapsible:false"
						...
						<table cellpadding="0" cellspacing="0" class="ourtable">
							...
							<tr >
								<td colspan="5">
									<input class="easyui-textbox" id="F_fHandleTitle" readonly="readonly" name="fHandleTitle"  style="width:670px;" value="${bean.fHandleTitle}"/>
								</td>
							</tr> --%>
					...
					<div title="处置单详情" data-options="iconCls:'icon-xxlb',collapsed:false,collapsible:false" style="overflow:auto;margin-top:10px;">
						<table class="ourtable" cellpadding="0" cellspacing="0">
							...
							<c:if test="${swglg==1}">
								<tr class="trbody">
									<td class="td1">
										<span style="color: red">*</span>&nbsp;资产处置定价文件
									</td>
								...
								<tr class="trbody">
									<td class="td1">
										<span style="color: red">*</span>&nbsp;区财政局批复文件
									</td>
								...
								<tr class="trbody">
									<td class="td1">
										<span style="color: red">*</span>&nbsp;非税收入统一缴款书
									</td>
					...
					<div title="处置清单表" data-options="iconCls:'icon-xxlb',collapsed:false,collapsible:false" style="overflow:auto;margin-top:10px;">
						<%@ include file="handle_dispose_accept_plan.jsp" %>
					</div>
			...
			<div class="window-left-bottom-div">
				<a href="javascript:void(0)" onclick="handleDisposeAccept();">
	...
	<script type="text/javascript">
		function handleDisposeAccept(){
			$('#handleDisposeAcceptForm').form('submit', {
				onSubmit: function(param){ 
   				...
   				url:base+'/Handle/updateDisposeAccept', 
   				success:function(data){
   					...
   					if(data.success){
   						...
   						closeWindow();
   						$('#handleDisposeAcceptForm').form('clear');
   						$("#handle_low_dg").datagrid('reload'); 
   						$("#handle_fixed_dispose_dg").datagrid('reload');
   					}else{
