...
function getPlan1(){
	...
	for(var i = 0;i < rows.length;i++){
		...
		/* if(rows[i].fResidualValue==''||rows[i].fDepreciationAmount==''||rows[i].fAssAmount==''||rows[i].fResidualValue==null||rows[i].fDepreciationAmount==null||rows[i].fAssAmount==null){
			 return false;
		} */
	}
