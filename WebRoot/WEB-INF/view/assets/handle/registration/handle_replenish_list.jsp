...
<div class="list-div">
	<div style="height: 10px;background-color:#f0f5f7 "></div>
		...
		<div style="margin: 0 10px 0 10px;height: 420px;" >
			<table id="handle_replenish_dg" class="easyui-datagrid"
			data-options="collapsible:true,url:'${base}/Handle/replenishJson?fAssType=${fAssType}',
			...
			selectOnCheck: true,checkOnSelect:true,remoteSort:true,nowrap:false,striped: true,fitColumns: true" >
				<thead>
					<tr>
						...
						<th data-options="field:'fRepStauts',align:'center',formatter:formatRepStauts,resizable:false,sortable:true" width="10%">补录状态</th>
...
function CZ(val, row) {
	if(row.fRepStauts==0){
		...
		+'<a href="#" onclick="reg_handle_detail(' + row.fId
		...
		+ '<a href="#" onclick="reg_handle_update(' + row.fId
		+ ')" class="easyui-linkbutton"><img onmouseover="listMouseOver(this)" onmouseout="listMouseOut(this)" src="'+base+'/resource-modality/${themenurl}/list/shangchuan1.png">' + '</a>'
		+'</td></tr></table>';
	}else {
		return '<table><tr style="width: 105px;height:20px"><td style="width: 25px">'
				+'<a href="#" onclick="reg_handle_detail(' + row.fId
		...
		$.ajax({
			...
			success : function(data) {
				if (data.success) {
					...
					$('#handle_replenish_dg').form('clear');
