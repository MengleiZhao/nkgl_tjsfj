...
<form id="handleAddEditIntangible" method="post" data-options="novalidate:true" class="easyui-form" enctype="multipart/form-data">
<div class="window-div">
		<div class="window-left-div" data-options="region:'west',split:true" style="width:745px;height: 491px;border: 1px solid #D9E3E7;margin-top: 20px;">
			<div class="win-left-top-div">
				...
				<div class="easyui-accordion" style="width:700px;margin-left: 20px;">
					<div  title="无形资产处置签报表" id="cgxxdiv" data-options="collapsed:false,collapsible:false"
						style="overflow:auto;margin-top: 10px;">
						<table cellpadding="0" cellspacing="0" class="ourtable">
							<!-- 表单样式参考 -->
							<tr >
								<td style="width: 150px" colspan="5">无形资产处置签报名称</td>
							</tr>
							<tr >
								<td colspan="5">
			...
			<div class="window-left-bottom-div">
				<a href="javascript:void(0)" onclick="handleAddEditIntangible(0);">
					<img src="${base}/resource-modality/${themenurl}/button/zhanchun1.png" onMouseOver="mouseOver(this)" onMouseOut="mouseOut(this)">
				</a>&nbsp;&nbsp;&nbsp;
				<a href="javascript:void(0)" onclick="handleAddEditIntangible(1)">
	...
	<script type="text/javascript">
		function handleAddEditIntangible(sts){
			...
			var planHandleInta = getPlanHandleInta();
			if(planHandleInta==false){
				alert('请填写完整价值信息！');
				return false;
			}
			if(planHandleInta==''||planHandleInta=='[]'){
				alert('请选择需要处置的资产！');
				return false;
			}
			$('#handleAddEditIntangible').form('submit', {
				onSubmit: function(param){ 
					param.planJson=planHandleInta;
   				...
   				success:function(data){
   					...
   					if(data.success){
   						...
   						closeWindow();
   						$('#handleAddEditIntangible').form('clear');
    ...
    var ue = UE.getEditor('fHandleText');
    
  //对编辑器的操作最好在编辑器ready之后再做
  ue.ready(function() {
	  var fHandleText ='${bean.fHandleText}';
      //设置编辑器的内容
      if(fHandleText==''){
     	 ue.setContent('');
      }else{
      	ue.setContent(fHandleText);
      }
  });
</script>
</body>