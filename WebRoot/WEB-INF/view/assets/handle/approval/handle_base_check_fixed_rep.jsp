...
<form id="saveRepfixedHandle" method="post" data-options="novalidate:true" class="easyui-form" enctype="multipart/form-data">
<div class="window-div">
 ...
 <!-- 审批附件 --><input type="hidden" name="spjlFile" id="spjlFile" value=""/>
						...
						<table class="ourtable" cellpadding="0" cellspacing="0">
							...
							<tr class="trbody">
								...
								<tr class="trbody" id="trFJ02">
									<td class="td1">
										<span class="style1">*</span>区财政局批复文件
			...
			<div class="window-left-bottom-div">
					<a href="javascript:void(0)" onclick="saveRepFixedHandle()">
	...
	function saveRepFixedHandle(){
		...
		$('#saveRepfixedHandle').form('submit', {
				onSubmit: function(){ 
