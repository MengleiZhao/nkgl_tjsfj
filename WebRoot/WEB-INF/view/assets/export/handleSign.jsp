 ...
 <body link="blue" vlink="purple">
  <table width="1083" border="0" cellpadding="0" cellspacing="0" style='width:812.25pt;border-collapse:collapse;table-layout:fixed;'>
   ...
   <tr height="34" style='height:25.50pt;'>
    ...
    <td class="xl65" width="867" colspan="8" style='width:650.25pt;border-right:none;border-bottom:none;' x:str>${bean.fHandleTitle }</td>
   ...
   <tr height="33.33" style='height:25.00pt;mso-height-source:userset;mso-height-alt:500;'>
    ...
    <td class="xl67" colspan="8" rowspan="7" style='border-right:none;border-bottom:none;' x:str><span style='mso-spacerun:yes;'>&nbsp;&nbsp;&nbsp;&nbsp;${bean.fHandleText}</span></td>
   ...
   <tr height="33.33" style='height:25.00pt;mso-height-source:userset;mso-height-alt:500;'>
    <td class="xl66" height="33.33" style='height:25.00pt;'></td>
    <td class="xl68" colspan="8" rowspan="3" style='border-right:none;border-bottom:none;' x:str>${bean.fRecUser}<br/><br/>${bean.fReqTimes}</td>
    <td colspan="2" style='mso-ignore:colspan;'></td>
   </tr>
   <tr height="33.33" style='height:25.00pt;mso-height-source:userset;mso-height-alt:500;'>
    <td class="xl66" height="33.33" style='height:25.00pt;'></td>
