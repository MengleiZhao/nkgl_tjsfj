...
.xl74
 ...
 <body link="blue" vlink="purple">
  <table width="1348.80" border="0" cellpadding="0" cellspacing="0" style='width:1011.60pt;border-collapse:collapse;table-layout:fixed;'>
   ...
   <col width="84.20" style='mso-width-source:userset;mso-width-alt:2694;'/>
   ...
   <col width="94.27" style='mso-width-source:userset;mso-width-alt:3016;'/>
   <col width="120" style='mso-width-source:userset;mso-width-alt:3840;'/>
   <col width="107.13" style='mso-width-source:userset;mso-width-alt:3428;'/>
   <col width="112.80" span="2" style='mso-width-source:userset;mso-width-alt:3609;'/>
   <col width="134.9378.53" style='mso-width-source:userset;mso-width-alt:4317;'/>
   <tr height="33.33" style='height:25.00pt;mso-height-source:userset;mso-height-alt:500;'>
    ...
    <td width="84.20" style='width:63.15pt;'></td>
    <td width="72.87" style='width:54.65pt;'></td>
    <td width="108.53" style='width:81.40pt;'></td>
    <td width="74.27" style='width:55.70pt;'></td>
    <td width="94.27" style='width:70.70pt;'></td>
    <td width="120" style='width:90.00pt;'></td>
    <td width="107.13" style='width:80.35pt;'></td>
    <td width="112.80" style='width:84.60pt;'></td>
    <td width="112.80" style='width:84.60pt;'></td>
    <td width="134.93" style='width:101.20pt;'></td>
   </tr>
   <tr height="34" style='height:25.50pt;'>
    <td class="xl66" height="34" colspan="14" style='height:25.50pt;border-right:none;border-bottom:none;' x:str>天津市滨海新区财政局固定资产处置申请单</td>
   </tr>
   <tr height="33.33" style='height:25.00pt;mso-height-source:userset;mso-height-alt:500;'>
    <td class="xl65" height="33.33" style='height:25.00pt;' x:str>处置单号：</td>
    <td class="xl67" colspan="5" style='border-right:none;border-bottom:none;'>${bean.fAssHandleCode }</td>
    <td class="xl65" colspan="6" style='mso-ignore:colspan;'></td>
    <td class="xl73" x:str>申请日期：</td>
    <td class="xl67" style='border-right:none;border-bottom:none;'><fmt:formatDate value="${bean.fReqTime}" pattern="yyyy-MM-dd"/></td>
   </tr>
   <tr height="33.33" style='height:25.00pt;mso-height-source:userset;mso-height-alt:500;'>
    ...
    <td class="xl68" colspan="5" style='border-right:.5pt solid windowtext;border-bottom:.5pt solid windowtext;'>${bean.fAcceptName }</td>
   </tr>
   <tr height="33.33" style='height:25.00pt;mso-height-source:userset;mso-height-alt:500;'>
    ...
    <td class="xl68" colspan="5" style='border-right:.5pt solid windowtext;border-bottom:.5pt solid windowtext;'>${bean.fMeetNumber }</td>
   </tr>
   <tr height="33.33" style='height:25.00pt;mso-height-source:userset;mso-height-alt:500;'>
    ...
    <td class="xl68" colspan="5" style='border-right:.5pt solid windowtext;border-bottom:.5pt solid windowtext;'>${bean.fRecDept }</td>
   </tr>
   <tr height="33.33" style='height:25.00pt;mso-height-source:userset;mso-height-alt:500;'>
    <td class="xl69" height="33.33" colspan="14" style='height:25.00pt;border-right:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>处置清单</td>
   </tr>
   <tr height="33.33" style='height:25.00pt;mso-height-source:userset;mso-height-alt:500;'>
    ...
    <td class="xl70" rowspan="2" style='border-right:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>规格型号/<font class="font1"><br/></font><font class="font1">房产证号</font></td>
   ...
   <tr height="33.33" style='height:25.00pt;mso-height-source:userset;mso-height-alt:500;'>
    ...
    <td class="xl68" x:str>账面净值（元）<span style='display:none;'></span></td>
    <td class="xl68" x:str>累计折旧（元）</td>
   ...
   <tr height="33.33" style='height:25.00pt;mso-height-source:userset;mso-height-alt:500;'>
    <td class="xl70" height="33.33" style='height:25.00pt;'>${list.fAssCode.toString() }</td>
    <td class="xl70">${list.fAssName }</td>
    <td class="xl70">${list.fFixedType }</td>
    <td class="xl70">${list.fFormShow }</td>
    <td class="xl70">${list.fAssModel }</td>
   ...
   <tr height="33.33" style='height:25.00pt;mso-height-source:userset;mso-height-alt:500;'>
    <td class="xl69" height="33.33" colspan="14" style='height:25.00pt;border-right:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>审签</td>
   </tr>
   ...
   <c:forEach items="${checkList }" var="check" begin="0" end="0">
    <td class="xl68" height="173.33" colspan="2" rowspan="3" style='height:130.00pt;border-right:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>${check.fRoleName }</td>
