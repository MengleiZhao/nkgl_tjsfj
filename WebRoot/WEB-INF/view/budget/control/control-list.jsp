...
<body style="background-color: #f0f5f7;text-align: center;">
		...
		<table style="width: 100%;font-size: 12px;">
				<tr>
					...
					<td align="right" >
						<a href="#" onclick="addControl()">
							<img src="${base}/resource-modality/${themenurl}/button/xzys1.png"
								onmouseover="this.setAttribute('src','${base}/resource-modality/${themenurl}/button/xzys2.png')"
								onmouseout="this.setAttribute('src','${base}/resource-modality/${themenurl}/button/xzys1.png')"
							/>
						</a>
					</td>
				</tr>
			...
			selectOnCheck: true">
				<thead>
					<tr>
						...
						<th data-options="field:'fBudgetControlBum',align:'center'" width="10%">预算控制数编号</th>
						<th data-options="field:'fBudgetYear',align:'center',formatter: dateformat_year" width="10%">预算年度</th>
						<th data-options="field:'fAllAmount',align:'center'" width="15%">单位预算总额（万元）</th>
						<th data-options="field:'fBasicExpAmount',align:'center'" width="15%">基本支出总额（万元）</th>
						<th data-options="field:'fProExpAmount',align:'center'" width="15%">项目预算总额（万元）</th>
						<th data-options="field:'fUser',align:'center'" width="10%">编制人</th>
						<th data-options="field:'fTime',align:'center',resizable:false,sortable:true,formatter: dateformat_controllist" width="10%">编制日期</th>
