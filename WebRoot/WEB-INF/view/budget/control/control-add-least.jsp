...
<table id="control-add-leave" class="easyui-datagrid" 
	...
	<thead>
		<tr>
			<th data-options="field:'fproCode',width:'18%'">项目编号</th>
			<th data-options="field:'fproName',width:'18%'">项目名称</th>
			<th data-options="field:'fproClassName',width:'12%'">项目类别</th>
			<th data-options="field:'fproAppliPeople',width:'10%'">申报人</th>
			<th data-options="field:'fproAppliDepart',width:'9%'">申报部门</th>
			<th data-options="field:'fproAppliTime',align:'center',resizable:false,sortable:true,formatter: formartDate_con_add_leave" width="10%">申报时间</th>
			<th data-options="field:'fproBudgetAmount',width:'14%',align:'center'">申报金额（万元）</th>
			<th data-options="field:'controlNum',width:'12%',
				editor:{
					type:'numberbox',
	               	options:{
