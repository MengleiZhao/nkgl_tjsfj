								...
								<div title="基本信息" data-options="iconCls:'icon-xxlb'" style="overflow:auto;margin-top: 10px;">
									<table cellpadding="0" cellspacing="0" class="ourtable" border="0">
										...
										<tr>
											...
											<td class="td2">
           										<c:if test="${empty bean.ftId}"><!--新增页面  默认不启用不可操作  -->
													<span>
               											<input type="radio"  name="fisOn" disabled="disabled" checked="checked" value="0">否</input>
                										<input type="radio"  name="fisOn" disabled="disabled"  value="1">是</input>
           											</span>
												</c:if>
											...
											<td class="td2">
           										<c:if test="${empty bean.ftId}"><!--新增页面  默认不启用不可操作  -->
													<span>
               											<input type="radio"  name="fisCo" disabled="disabled" checked="checked" value="0">否</input>
                										<input type="radio"  name="fisCo" disabled="disabled"  value="1">是</input>
           											</span>
												</c:if>
												<c:if test="${!empty bean.ftId}">
													<span>
										...
										<tr style="height: 70px;">
											...
											<td class="td2" colspan="4">
												<%-- <input class="easyui-textbox" type="text"
												 id="F_ftempDesc"  name="ftempDesc" data-options="validType:'length[0,200]',multiline:true"
									...
									<table cellpadding="0" cellspacing="0" class="ourtable3" border="0">
										...
										<tr>
											...
											<td class="td2" colspan="3">
												<span>
												   <input type="radio"  name="fisAvoid"  onclick="clearIds(this)"  <c:if test="${fevalbean.fisAvoid=='0'}">checked="checked"</c:if> value="0">否</input>
												   <input type="radio"  name="fisAvoid"  onclick="alertQingdan(this)"   <c:if test="${fevalbean.fisAvoid=='1'}">checked="checked"</c:if> value="1">是</input>
           										</span>
											</td>
										</tr>
										...
										<tr>
											...
											<td class="td2" colspan="3">
												...
												<c:if test="${!empty bean.ftId}">
													<input id="F_fevalType" name="fevalType.code"  class="easyui-combobox" style="width: 150px"
