...
<div class="list-div">
	...
	<div class="list-table">
		<table id="pro_dg_${listid}" class="easyui-datagrid"
			...
			method:'post',fit:true,pagination:true,singleSelect: true,scrollbarSize:0,onLoadSuccess:onLoadSuccessMothedE,
			selectOnCheck: true,checkOnSelect:true,remoteSort:true,nowrap:false,striped: true,fitColumns:true" >
				<thead>
					<tr>
						...
						<th data-options="field:'fproBudgetAmount',align:'right',formatter:function(value,row,index){return fomatMoney(value,2);}" width="10%">基本支出预算[万元]</th>
...
function detailPro(proId){
	var win=creatWin('查看-基本支出信息', 1230,630, 'icon-search', '/project/detail/'+proId+'?sign=0');
	win.window('open');
}
function editPro(id){
