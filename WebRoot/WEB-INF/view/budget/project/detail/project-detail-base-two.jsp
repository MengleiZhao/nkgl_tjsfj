		...
		<table cellpadding="0" cellspacing="0">
			<tr class="trbody">
		   	...
		   	<tr class="trbody">
		     	...
		     	<td colspan="4">
		     		<!-- 基本支出项目名称 ,  取消手动收入，改为二级醒目名称 -->
		     		<input id="project_add_FProName" name="FProName" readonly="readonly" class="easyui-textbox" style="width:750px"
		     		  value="<c:out value="${bean.FProName}"></c:out>" >
		     	</td>
		   	</tr>
