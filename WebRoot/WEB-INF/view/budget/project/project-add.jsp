...
<form id="project_add_form" method="post" data-options="novalidate:true" class="easyui-form" enctype="multipart/form-data">
	<div class="easyui-layout" style="height: 559px;">
		<div class="win-left-div-ys" id="aaaaaaa" data-options="region:'west',split:true">
...
<script type="text/javascript">
	...
	function saveProject(saveType){
		...
		if('sb'==saveType){
			...
			/* $('#outcome10_0').val(0);
			var tab1 = document.getElementsByClassName("pro_outcome_input");
			console.log(tab1);
			
			for (var i = 0; i < tab1.length; i++) {
				var j = 0;
				if(i==1){
					var tabid = document.getElementById("outcome10_"+(i+1)).value;
					if(tabid==null||tabid==''){
						$('#outcome10_'+j).val(0);
					}
				}else {
