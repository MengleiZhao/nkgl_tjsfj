...
<div class="list-div">
	...
	<div class="list-top">
		<table class="top-table" cellpadding="0" cellspacing="0">
			<tr>
				<td style="width: 80%;padding-left: 15px" class="queryth">
					&nbsp;项目名称&nbsp;
					...
					<%-- &nbsp;&nbsp;项目类别&nbsp;
					<select id="pro_tzlist_query_fproClass" style="width: 150px;height:25px;" class="easyui-combobox" data-options="required:false,editable:false" >
