...
<div id="chart_1_1" style="height:450px; width:600px; margin: 0 auto;" >
				...
				<table cellpadding="0" cellspacing="0"
					...
					<tr>
						<td style="padding-left: 10px; width: 160px;"><span
							style="font-size: 12px; color: #182C4D;">当前日期：</span> <span
							style="font-size: 12px; color: #0053DC; font-weight: bold;">${month}</span>
						</td>
		...
		<div data-options="region:'center'">
			<div style="height: 100%; width:98%; margin-left: 1%;">
				<table id="pro_dg" class="easyui-datagrid"
					data-options="collapsible:true,url:'${base}/cockDetail/chartDataList?type=inner5&indexType=inner5_2&itemName=${itemName}&year=${year}&month=${month}&id=${departId}',
				...
				selectOnCheck: true,checkOnSelect:true,remoteSort:true,nowrap:false,striped: true,fitColumns:true">
					<thead>
						<tr>
							...
							<th data-options="field:'amount',align:'right'" width="13%">支出金额(元)</th>
							<th
...
function goback(){
	...
	var win = parent.creatCockFirstWin(itemType+' 使用情况', 677,400, 'icon-search',encodeURI('/cockDetail/inC5?itemName=${itemName}&year='+queryYear+'&departId='+queryDepartId));
	win.window('open');
}
//操作栏创建
function CZ(val, row) {
