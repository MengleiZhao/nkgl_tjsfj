		...
		<div data-options="region:'center'">
			<div style="height: 100%; width:98%; margin-left: 1%;">
				<table id="pro_dg" class="easyui-datagrid"
					data-options="collapsible:true,url:'${base}/cockDetail/chartDataList?type=meeting&id=${departNameId}&year=${year}',
...
//点击 返回(生成饼图)
function goback(){
	var win = parent.creatCockFirstWin('查看-会议支出统计', 677,400, 'icon-search','/cockDetail/inC3?type=meeting&year='+queryYear+'&departId='+queryDepartId);
	win.window('open');
