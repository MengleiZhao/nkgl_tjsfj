				...
				<table cellpadding="0" cellspacing="0"
					...
					<tr>
						<td style="padding-left: 10px; width: 160px;"><span
							style="font-size: 12px; color: #182C4D;">当前类型：</span> <span
							style="font-size: 12px; color: #0053DC; font-weight: bold;">${indexName}</span>
						</td>
						<td id="quota_list_top1"
							style="text-align: right; padding-right: 10px; "><span
							style="font-size: 12px; color: #182C4D;">会议名称</span> <input
		...
		<div data-options="region:'center'">
			<div style="height: 100%; width:98%; margin-left: 1%;">
				<table id="pro_dg" class="easyui-datagrid"
					data-options="collapsible:true,url:'${base}/cockDetail/chartDataList?type=meeting&indexType=${indexType}&id=${departId}&year=${year}',
...
function editApply(id,type) {
	/*type为修改或查看1位修改，0位查看  detail为驾驶舱详情查看*/
	var win = creatWin('查看 ', 1070, 580, 'icon-search', "/reimburse/edit?id="+ id+"&editType=0");
	win.window('open');
}	
</script>
