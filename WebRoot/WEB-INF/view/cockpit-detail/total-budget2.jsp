		...
		<div class="tab-wrapper" id="quota-tab" >
			...
			<div class="tab-content">
				<div style="height: 355px; width:98%; margin-left: 1%;">
					<table id="basicIndex"
					data-options="collapsible:true,url:'${base}/cockDetail/indexDataList?typeStr=budget&id=${departNameId}&year=${year}&indexType=0',
					...
					selectOnCheck: true,checkOnSelect:true,remoteSort:true,nowrap:true,striped: true,fitColumns:true" >
						<thead>
							<tr>
								...
								<th data-options="field:'zcAmount',align:'right',formatter:zcAmount" style="width: 16%">执行金额(万元)</th>
			   	...
			   	<div style="height: 355px;width:749px; margin-left: 1%;">
				    <table id="proIndex"
					data-options="collapsible:true,url:'${base}/cockDetail/indexDataList?typeStr=budget&id=${departNameId}&year=${year}&indexType=1',
					method:'post',pageSize:9,fit:true,pagination:true,singleSelect: true,
					selectOnCheck: true,checkOnSelect:true,remoteSort:true,nowrap:true,striped: true,fitColumns:true" >
						<thead>
							<tr>
...
function zcAmount(val, row) {
	return parseFloat(row.xdAmount-row.djAmount-row.syAmount).toFixed(2);
}
