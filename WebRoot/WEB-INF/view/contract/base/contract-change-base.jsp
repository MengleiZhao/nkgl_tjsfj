		...
		<table cellpadding="0" cellspacing="0"  class="ourtable">
			<tr class="trbody">
				...
				<td colspan="4">
					...
					<textarea name="fUptReason"  id="Upt_fUptReason"  class="textbox-text" oninput="textareaNum(this,'textareaNum1')" autocomplete="off"  style="width:555px;height:100px">${Upt.fUptReason }</textarea>
			...
			<tr>
				...
				可输入剩余数：<span id="textareaNum1" class="200">
					<c:if test="${empty Upt.fUptReason}">200</c:if>
					<c:if test="${!empty Upt.fUptReason}">${200-Upt.fUptReason.length()}</c:if>
					</span>
				</td>
			</tr>
			<tr class="trbody">
				...
				<td>
					<input class="easyui-combobox" id="Upt_fContUptType" name="fContUptType" style="width: 200px;" data-options="editable:false,panelHeight:'auto',url:'${base}/Formulation/lookupsJson?parentCode=HTBGLX&selected=${Upt.fContUptType}',method:'POST',valueField:'code',textField:'text',editable:false,validType:'selectValid'">
				</td>
				<td class="td4">&nbsp;</td>
				<td class="td1" ><span class="style1">*</span>&nbsp;变更日期</td>
				<td>
					<input class="easyui-datebox" id="Upt_fUptdate" value="${Upt.fUptdate }" name="fUptdate" style="width: 200px;" data-options="editable:false,required:true">
				</td>
			</tr>
			<tr class="trbody">
				<td class="td1">
