...
<table id="change-plan-dg" class="easyui-datagrid" style="width:650px;height:auto;"
	...
	<thead>
		<tr>
			...
			<th data-options="field:'fRecStage',editor:{type:'textbox',editable:false,options:{required:true}},validType:'length[1,20]',align:'center'" style="width: 12%">付款阶段</th>
			<th data-options="field:'fReceCondition',editor:{type:'textbox',editable:false,options:{required:true}},validType:'length[1,50]',align:'center'"style="width: 13%">付款条件</th>
			<th data-options="field:'fRecePlanTime',align:'center',editor:{type:'datebox',editable:false,options:{required:true,precision:1}}"style="width: 15%">预计付款时间</th>
			<th data-options="field:'fRecePlanAmount',align:'right',editor:{type:'numberbox',editable:false,options:{required:true,precision:2,onChange:setFsumMoney}}"style="width: 16%">预计付款金额(元)</th>
