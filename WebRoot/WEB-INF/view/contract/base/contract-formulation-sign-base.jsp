...
<table cellpadding="0" cellspacing="0"  class="ourtable">
	<tr class="trbody">
		...
		<td>
			<input class="easyui-textbox" id="f_fOfficialUser" name="fOfficialUser" required="required" data-options="validType:'length[1,50]'" style="width: 200px" value="${signInfo.fOfficialUser}"/>
		</td>
		<td class="td4">&nbsp;</td>
		<td class="td1"><span class="style1">*</span>&nbsp;是否法定代表人签字</td>
		<td>
			<input type="radio" id="f_fIsOfficialUserYes" onclick="fIsOfficialUserYes()" name="fIsOfficialUser"<c:if test="${signInfo.fIsOfficialUser==1}">checked="checked"</c:if> value="1" >是
			<input type="radio" id="f_fIsOfficialUserNo" onclick="fIsOfficialUserNo()" name="fIsOfficialUser"<c:if test="${signInfo.fIsOfficialUser==0}">checked="checked"</c:if> value="0"  >否
		</td>
	</tr>
	<tr class="trbody">
		<td class="td1"><span class="style1">*</span>&nbsp;对方联系人</td>
		<td>
			<input class="easyui-textbox" id="f_fConcUser" name="fConcUser" required="required" data-options="validType:'length[1,25]'" style="width: 200px" value="${signInfo.fConcUser}"/>
		</td>
		<td class="td4">&nbsp;</td>
		<td class="td1"><span class="style1">*</span>&nbsp;联系电话</td>
		<td>
			<input class="easyui-textbox" id="f_fConcTel" name="fConcTel" required="required" data-options="validType:'length[1,13]',validType:'mobileAndTel'" style="width: 200px" value="${signInfo.fConcTel}"/>
		</td>
	</tr>
	<tr class="trbody" id="bankCode">
		<td class="td1"><span class="style1">*</span>&nbsp;银行账户</td>
		<td colspan="4">
			<input class="easyui-textbox" id="f_fCardNo" name="fCardNo" data-options="validateOnCreate:false" style="width: 555px" value="${signInfo.fCardNo}"/>
		</td>
	</tr>
	<tr class="trbody" id="bank">
		<td class="td1"><span class="style1">*</span>&nbsp;开户银行</td>
		<td colspan="4">
			<input class="easyui-textbox" id="f_fBankName" name="fBankName" data-options="validateOnCreate:false,validType:'length[1,25]'" style="width: 555px" value="${signInfo.fBankName}"/>
		</td>
	</tr>	
	<tr hidden="hidden" class="trbody fIsOfficialUser">
		<td class="td1"><span class="style1">*</span>&nbsp;授权代表人</td>
		<td>
			<input class="easyui-textbox" id="f_fLegalUser" name="fLegalUser" data-options="" style="width: 200px" value="${signInfo.fLegalUser}"/>
		</td>
		<td class="td4">&nbsp;</td>
		<td class="td1"></td>
		<td></td>
