		...
		<table class="top-table" cellpadding="0" cellspacing="0">
			<tr>
				...
				<!-- <div id='othersearchtd' class="top-table-search-td" hidden="hidden" style="margin-bottom: 10px;">
					合同编号&nbsp;
					<input id="e_fcCode" name="contCode" style="width: 150px;height:25px;" class="easyui-textbox"></input>
					&nbsp;&nbsp;合同名称&nbsp;
...
function enforcing_detail(id) {
	var win = creatWin('查看', 1115, 600, 'icon-search', '/Enforcing/detail?id='+id+'&detailType=htbx');
	win.window('open'); 
}
//删除
