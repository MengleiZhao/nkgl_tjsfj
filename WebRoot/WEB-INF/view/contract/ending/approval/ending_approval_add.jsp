...
<body>
<div class="win-div">
<form id="endingApprovalEditFrom" action="${base}/ending/save" method="post" data-options="novalidate:true" class="easyui-form" enctype="multipart/form-data">
		...
		<div class="win-left-div" data-options="region:'west',split:true">
			<div class="win-left-top-div">
	    		...
	    		<c:if test="${bean.fcId!=null}">
	    			...
	    			<input type="hidden" name="ftype" id="endCheck_ftype" value="3"/>
...
flashtab('contract-formulation-add');
	...
	function check(stauts){
		...
		var fEndId=$('#end_fEndId').val();
		var fcId=$('#F_fcId').val();
		$('#endingApprovalEditFrom').form('submit', {
				onSubmit: function(){ 
				...
				url:'${base}/ending/approve/'+stauts+'?Id='+fcId+'&endingId='+fEndId,
			//	data:{'Id':fcId,'endingId':fEndId},
				success:function(data){
					if(flag){
					...
					if(data.success){
						...
						closeWindow();
						$('#endingApprovalEditFrom').form('clear');
		...
		function checkMobileNo(){
		 ...
		 $('#F_fcType').combobox({  
		   ...
		   /*  function getFilePath(){  
				...
				//baocun
				function endingApprovalEditFrom(){
					$("#end_stauts").val('0');
		    		$('#endingApprovalEditFrom').form('submit', {
		   				onSubmit: function(){ 
		   					flag=$(this).form('enableValidation').form('validate');
