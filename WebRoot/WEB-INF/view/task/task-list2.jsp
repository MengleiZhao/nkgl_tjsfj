...
<div class="list-div">
		...
		<table class="top-table" cellpadding="0" cellspacing="0">
			<tr>
				...
				<td class="top-table-td2">
					<input id="apply_taskName2" name=""  style="width: 150px;height:25px;" class="easyui-textbox"></input>
				</td>
				...
				<td class="td1">提交人：</td> 
				<td class="top-table-td2">
					<input id="apply_beforeUser2" name=""  style="width: 150px;height:25px;" class="easyui-textbox"></input>
				</td>
	...
	<div class="list-table">
		<%-- <table class="easyui-datagrid" style="height: 300px" id="task_dg2"
		...
		selectOnCheck: true,checkOnSelect:true,remoteSort:true,nowrap:false,striped: true,fitColumns: true" >
			<thead>
				<tr>
					...
					<th data-options="field:'cz',align:'left',formatter:indexCZ2" style="width: 15%">操作</th>
				</tr>
			</thead>
		</table> --%>
		<jsp:include page="../../../newMain/index-tabs/bjsx.jsp" />
	</div>
</div>
