 ...
 */
@Controller
@RequestMapping(value = "/insideLedger")
public class insideLedgerController extends BaseController {
	@Autowired
	private InsideAdjustMny adjustMny;
	@Autowired
	...
	public String list(ModelMap model) {
		return "/WEB-INF/view/budget/adjust/insideLedger-list";
	}
